...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $sth->bindParam(':file_show_type', $_POST['file_show_type'], PDO::PARAM_INT);
        $sth->bindParam(':file_width', $_POST['file_width'], PDO::PARAM_INT);
        $sth->bindParam(':file_height', $_POST['file_height'], PDO::PARAM_INT);
        $sth->bindParam(':file_id', $_POST['file_id'], PDO::PARAM_INT);
        $sth->execute();
