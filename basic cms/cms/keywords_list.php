...
if (isset($_GET['totalRows'])) {
  ...
  $totalRows = mysql_num_rows($all_Reckeywords);
}
    ...
    <tr>
      ...
      do {
		...
		//echo $totalRows_RecImage;
            ?>
            <td align="center" class="table_data" ><a href="keywords_edit.php?d_id=<?php echo $row_Reckeywords['d_id']; ?>"><?php echo $row_Reckeywords['d_date']; ?></a></td>
           ...
           <td align="center" class="table_data" ><a href="keywords_edit.php?d_id=<?php echo $row_Reckeywords['d_id']; ?>"><?php echo $row_Reckeywords['d_title']; ?></a></td>
