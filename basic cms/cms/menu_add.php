...
<body>
  <table width="1280" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
                ...
                <td>
                  <table width="100%" border="0" cellpadding="5" cellspacing="3">
                    <tr>
                      ...
                      <td><label>
                        <select name="d_class2" id="d_class2">
                          ...
                          do {
                            ?>
                            <option value="<?php echo $row_RecmenuC['c_id']?>"<?php if (!(strcmp($row_RecmenuC['c_id'], $G_selected1))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecmenuC['c_title']?></option>
                            <?php
                    ...
                    <tr>
                      ...
                      <td><input name="d_title_en" type="text" class="table_data" id="d_title_en" size="80" /></td>
                      <td bgcolor="#e5ecf6">&nbsp;</td>
                    </tr>

                    <tr>
                      <td align="center" bgcolor="#e5ecf6" class="table_col_title">定價</td>
                      <td><input name="d_class3" type="text" class="table_data" id="d_class3" size="30" /></td>
                      <td bgcolor="#e5ecf6">&nbsp;</td>
                    </tr>
                   ...
                   <tr>
                     ...
                     <td><textarea name="d_content" cols="30" rows="20" class="table_data" id="d_content"></textarea></td>
                    ...
                    <tr>
                      ...
                      <td><textarea name="d_class5" cols="50" rows="8" class="table_data" id="d_class5"></textarea></td>
                      <td bgcolor="#e5ecf6" class="table_col_title"><p class="red_letter">*小斷行請按Shift+Enter。<br />
                       *請使用斷行區隔。</p></td>
                    </tr>
                       ...
                       <tr>
                         ...
                         <td class="table_data">
                          <div class="perm" id="perm_1">
                             <label for="seafood">
                               <input name="ingredients[]" type="checkbox" id="seafood" value="1">
                               海鮮
                             </label>
                             <label for="pig">
                              <input name="ingredients[]" type="checkbox" id="pig" value="2">
                              豬肉
                            </label>
                            <label for="chicken">
                              <input name="ingredients[]" type="checkbox" id="chicken" value="3">
                              雞肉
                            </label>
                            <label for="fish">
                              <input name="ingredients[]" type="checkbox" id="fish" value="4">
                              魚肉
                            </label>
                            <label for="vegetables">
                              <input name="ingredients[]" type="checkbox" id="vegetables" value="5">
                              蔬菜
                            </label>
                         </div>
      ...
      if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
        ...
        $insertSQL = sprintf("INSERT INTO data_set (d_title, d_title_en, d_content, d_class1, d_class2, d_class3, d_class4, d_class5, d_class6, d_data1, d_data2, d_data3, d_data4, d_date, d_active) VALUES (%s, %s, %s, 'menu', %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
 ...
 if($ifFile){
  ...
  //----------插入檔案資料到資料庫end----------
    ...
    $insertGoTo = "menu_list.php?selected1=".$d_class2."&pageNum=0&totalRows=".($_SESSION['totalRows']+1)."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
