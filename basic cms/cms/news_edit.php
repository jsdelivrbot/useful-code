...
$query_Recnews = sprintf("SELECT * FROM data_set WHERE d_id = %s", GetSQLValueString($colname_Recnews, "int"));
$Recnews = mysql_query($query_Recnews, $connect2data) or die(mysql_error());
$row_Recnews = mysql_fetch_assoc($Recnews);
$totalRows = mysql_num_rows($Recnews);
...
mysql_select_db($database_connect2data, $connect2data);
$query_RecCover = sprintf("SELECT * FROM file_set WHERE file_d_id = %s AND file_type = 'newsCover'", GetSQLValueString($colname_RecImage, "int"));
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="3" cellpadding="5">
                   <tr>
                     ...
                     <td width="532"><input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_Recnews['d_title']; ?>" size="50" />
                      <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_Recnews['d_id']; ?>" /></td>
                      <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                    </tr>

                    <tr>
                      <td align="center" bgcolor="#e5ecf6" class="table_col_title">內容</td>
                      <td><textarea name="d_content" cols="50" rows="30" class="table_data tiny" id="d_content"><?php echo $row_Recnews['d_content']; ?></textarea></td>
            	...
            	<!-- <tr>
            	  ...
            	  <td><input name="d_class5" type="text" class="table_data" id="d_class5" value="<?php echo $row_Recnews['d_class5']; ?>" size="50" /></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
             </tr> -->
             <tr>
               <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
               <td width="532"><input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo ( ($row_Recnews['d_date']=='') || (!(strcmp("0000-00-00 00:00:00", $row_Recnews['d_date']))) ) ? date("Y-m-d H:i:s") : $row_Recnews['d_date']; ?>" size="50"></td>
               <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
             </tr>
             <tr>
               ...
               <td width="532"><label>
                 <select name="d_active" class="table_data" id="d_active">
                   <option value="1" <?php if (!(strcmp(1, $row_Recnews['d_active']))) {echo "selected=\"selected\"";} ?>>顯示</option><option value="0" <?php if (!(strcmp(0, $row_Recnews['d_active']))) {echo "selected=\"selected\"";} ?>>不顯示</option>
                 </select></label></td>
                 <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
               </tr>
                ...
                <td><?php do { ?>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td align="left" class="table_data">&nbsp;圖片說明：<?php echo $row_RecCover['file_title']; ?></td>
                    </tr>
                    <tr>
                  ...
                  <?php } while ($row_RecCover = mysql_fetch_assoc($RecCover)); ?></td>
                  <td bgcolor="#e5ecf6" class="table_col_title"><p class="red_letter">*<?php echo $imagesSize['newsCover']['note'];?></p></td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <td bgcolor="#e5ecf6" class="table_col_title">
                      <p class="red_letter">*<?php echo $imagesSize['newsCover']['note'];?></p></td>
                    </tr>
                    <?php } // Show if recordset not empty ?>
...
do {
  ...
  <td><table width="320" border="1" cellpadding="0" cellspacing="0" bordercolor="#666666" class="table_frame_style">
    ...
    <tr>
      <td align="left" class="table_no_border"><a href="news_file_edit.php?file_id=<?php echo $row_RecFile['file_id']; ?>"><img src="image/media_edit.gif" width="16" height="16" title="修改檔案" /></a><a href="news_file_del.php?file_id=<?php echo $row_RecFile['file_id']; ?>"><img src="image/media_delete.gif" width="16" height="16" title="刪除檔案"/></a></td>
    </tr>
  </table></td>
  <?php  $RecFile_endRow++;
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  for($j=1;$j<count($image_result);$j++)
  {
    ...
    // Cover
    //一般附圖
  $image_result=image_process($_FILES['imageCover'], $_REQUEST['image_titleCover'], "newsCover","add", $imagesSize['newsCover']['IW'], $imagesSize['newsCover']['IH']);
  //echo count($image_result);
  //echo $image_result[0][0];
  ...
  for($j=1;$j<count($image_result);$j++)
  {
    $insertSQL = sprintf("INSERT INTO file_set (file_name, file_link1, file_link2, file_link3, file_type, file_d_id, file_title, file_show_type) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
     ...
     GetSQLValueString($image_result[$j][2], "text"),
     GetSQLValueString($image_result[$j][3], "text"),
     GetSQLValueString("newsCover", "text"),
     GetSQLValueString($_POST['d_id'], "int"),
     GetSQLValueString($image_result[$j][4], "text"),
     GetSQLValueString($image_result[$j][5], "int"));
