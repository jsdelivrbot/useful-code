      ...
      do {
        if ($i%2==0)
        {
          ...
          else
          {
            ...
            mysql_select_db($database_connect2data, $connect2data);
            $query_RecImage = sprintf("SELECT * FROM file_set WHERE file_type='newsCover' AND file_d_id = %s", GetSQLValueString($colname_RecImage, "int"));
		...
		//echo $totalRows_RecImage;
            ?>
            <td align="center" class="table_data" ><a href="news_edit.php?d_id=<?php echo $row_Recnews['d_id']; ?>"><?php echo $row_Recnews['d_date']; ?></a></td>
           ...
           <td align="center" class="table_data" ><a href="news_edit.php?d_id=<?php echo $row_Recnews['d_id']; ?>"><?php echo $row_Recnews['d_title']; ?></a></td>
           <td align="center"  class="table_data"><a href="news_edit.php?d_id=<?php echo $row_Recnews['d_id']; ?>"><img src="<?php if($totalRows_RecImage==0){echo "image/default_image_s.jpg";}else{echo "../".$row_RecImage['file_link2'];} ?>" alt="" class="image_frame" /></a></td>
