                ...
                <td><table width="100%" border="0" cellspacing="3" cellpadding="5">
                 <tr>
                   ...
                   <td width="532"><input name="d_title" type="text" class="table_data" id="d_title" value="" size="50" />
                    <input name="d_class1" type="hidden" id="d_class1" value="organization_banner" /></td>
                     ...
                     <!-- <tr>
                      ...
                      <td>
                        ...
                        <td bgcolor="#e5ecf6" class="table_col_title">
                          <p class="red_letter">*<?php echo $imagesSize['organization_bannerCover']['note'];?></p></td>
                        </tr> -->
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $Result1 = mysql_query($insertSQL, $connect2data) or die(mysql_error());
		...
		//$image_result=image_process("organization_banner","add", "0", "0");
		//一般附圖
   ...
   $insertGoTo = "organization_banner_list.php?pageNum=0&totalRows=".($_SESSION['totalRows']+1)."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
   if (isset($_SERVER['QUERY_STRING'])) {
