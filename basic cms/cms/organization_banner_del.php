                ...
                <td>
                  <table width="100%" border="0" cellspacing="3" cellpadding="5">
                   <tr>
                     ...
                     <td width="532" class="table_data"><?php echo $row_Recorganization_banner['d_title']; ?>
                      <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_Recorganization_banner['d_id']; ?>" />
                    ...
                    <tr>
                     ...
                     <td class="table_data"><?php echo $row_Recorganization_banner['d_content']; ?></td>
                     <td bgcolor="#e5ecf6">&nbsp;</td>
                   </tr>
                   <tr>
                     <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
                     <td width="532" class="table_data"><?php echo $row_Recorganization_banner['d_date']; ?></td>
                     <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                   </tr>
...
if ((isset($_REQUEST['d_id'])) && ($_REQUEST['d_id'] != "") && (isset($_REQUEST['delsure']))) {
 ...
 while ( $row = mysql_fetch_array($result))
 {
   ...
   $sql="SELECT * FROM file_set WHERE file_type='organization_bannerCover' AND file_d_id='".$_POST['d_id']."'";
   $result = mysql_query($sql)or die("無法送出".mysql_error( ));
   while ( $row = mysql_fetch_array($result))
   {
     if ( (isset($row['file_link1'])) && file_exists("../".$row['file_link1']) ) {
    ...
    $deleteSQL = sprintf("DELETE FROM file_set WHERE file_type='organization_bannerCover' AND file_d_id=%s",
     GetSQLValueString($_REQUEST['d_id'], "int"));
   ...
   $deleteGoTo = "organization_banner_list.php?delchangeSort=1";
