  		...
  		<tr>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	...
            	<tr>
            	  ...
            	  <td><input name="d_content" type="text" class="table_data" id="d_content" value="<?php echo $row_RecBannersHome['d_content']; ?>" size="50" /></td>
            	  <td bgcolor="#e5ecf6"><span class="red_letter">*若沒有連結，則不需填寫。</span></td>
          	  </tr>
                <tr>
