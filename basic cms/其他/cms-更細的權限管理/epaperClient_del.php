...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除電子報訂閱</td>
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">姓名</td>
          	    	<td width="532" class="table_data">
          	    	  <?php echo $row_RecEpaper_client['a_display_name']; ?><?php echo ($row_RecEpaper_client['a_gender']==1) ? " 先生" : " 女士" ; ?></td>
        	    	<td width="250" bgcolor="#e5ecf6">
          	    	  <input name="delsure" type="hidden" id="delsure" value="1" />
          	    	  <input name="a_id" type="hidden" id="a_id" value="<?php echo $row_RecEpaper_client['a_id']; ?>" /></td>
      	    	</tr>
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">電子信箱</td>
          	    	<td width="532"><label></label>
          	    	  <span class="table_data"><?php echo $row_RecEpaper_client['a_email']; ?></span></td>
          	     	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">使用狀態</td>
          	    	<td width="532"><label></label>
          	    	  <span class="table_data"><?php echo ($row_RecEpaper_client['a_status']) ? "允許" : "不允許"; ?></span></td>
          	     	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">訂閱狀態</td>
          	    	<td width="532"><label></label>
          	    	  <span class="table_data"><?php echo ($row_RecEpaper_client['a_epaper']) ? "訂閱中" : "取消訂閱"; ?></span></td>
          	     	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
                <?php if(0) {?>
                <tr>
                  <td align="center" bgcolor="#e5ecf6" class="table_col_title">電話</td>
                  <td><label class="table_data"><?php echo $row_RecEpaper_client['a_tel']; ?></label></td>
                  <td bgcolor="#e5ecf6" class="table_col_title"><p>&nbsp;</p></td>
                </tr>
                <tr>
                  <td align="center" bgcolor="#e5ecf6" class="table_col_title">住址</td>
                  <td class="table_data"><?php echo $row_RecEpaper_client['a_address']; ?></td>
                  <td bgcolor="#e5ecf6" class="table_col_title">&nbsp;</td>
                </tr>
                <?php } ?>
                <tr>
                  <td align="center" bgcolor="#e5ecf6" class="table_col_title">新增日期</td>
                  <td class="table_data"><?php echo $row_RecEpaper_client['a_date']; ?></td>
                  <td bgcolor="#e5ecf6" class="table_col_title">&nbsp;</td>
                </tr>
			</table>
            </td>
...
<?php
	if ((isset($_REQUEST['a_id'])) && ($_REQUEST['a_id'] != "") && (isset($_REQUEST['delsure']))) {
	  ...
	  $deleteSQL = sprintf("DELETE FROM address_book_set WHERE a_id=%s",
						   GetSQLValueString($_REQUEST['a_id'], "int"));
	
	  mysql_select_db($database_connect2data, $connect2data);
	  $Result1 = mysql_query($deleteSQL, $connect2data) or die(mysql_error());
	 
	  $deleteGoTo = "epaperClient_list.php?delchangeSort=1";
	  if (isset($_SERVER['QUERY_STRING'])) {
		$deleteGoTo .= (strpos($deleteGoTo, '?')) ? "&" : "?";
		$deleteGoTo .= $_SERVER['QUERY_STRING']."&pageNum_RecEpaper_client=".$_SESSION["ToPage"];
	  }
