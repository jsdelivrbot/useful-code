            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
          	    	<td width="532" class="table_data"><?php echo $row_RecEpaper['e_title']; ?>
          	    	  <input name="e_id" type="hidden" id="e_id" value="<?php echo $row_RecEpaper['e_id']; ?>" />
                ...
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td width="532" class="table_data"><?php echo $row_RecEpaper['e_date']; ?></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
                <tr>
...
<?php
	if ((isset($_REQUEST['e_id'])) && ($_REQUEST['e_id'] != "") && (isset($_REQUEST['delsure']))) {
	  ...
	  $deleteGoTo = "epaper_list.php?delchangeSort=1";
