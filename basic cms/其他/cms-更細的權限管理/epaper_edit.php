            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
                ...
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td width="532"><input name="e_date" type="text" class="table_data" id="e_date" value="<?php echo $row_RecEpaper['e_date']; ?>" size="50"></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">在網頁顯示</td>
          	        ...
          	        <select name="e_active" class="table_data" id="e_active">
          	          <option value="1" <?php if (!(strcmp(1, $row_RecEpaper['e_active']))) {echo "selected=\"selected\"";} ?>>顯示</option><option value="0" <?php if (!(strcmp(0, $row_RecEpaper['e_active']))) {echo "selected=\"selected\"";} ?>>不顯示</option>
       	            </select></label></td>
          	     	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
                <tr>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE epaper_set SET e_title=%s, e_content=%s,e_date=%s, e_active=%s WHERE e_id=%s",
  ...
  $Result1 = mysql_query($updateSQL, $connect2data) or die(mysql_error());
	...
	if(isset($_SESSION["ToPage"]) && $_SESSION["ToPage"]>=0){
		$toPage = $_SESSION["ToPage"];
	}else{
		$toPage = 0;
	}
  ...
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    $updateGoTo .= $_SERVER['QUERY_STRING']."&pageNum_RecEpaper=".$toPage;
  }
