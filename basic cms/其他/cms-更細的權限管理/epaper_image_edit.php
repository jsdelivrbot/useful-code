  		...
  		<tr>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
                ...
                <tr>
              	    ...
              	    <td><input name="image[]" type="file" class="table_data" id="image[]" size="50" >
              	      <span class="red_letter"><br />
              	      *檔案請上傳寬不大於680 pixel 72dpi 之圖檔。上傳之檔案請勿超過2M。</span></td>
              	    <td bgcolor="#e5ecf6" class="table_col_title"><p>&nbsp;</p>
           	        </td>
                </tr>
			</table>
            </td>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $Result1 = mysql_query($updateSQL, $connect2data) or die(mysql_error());
	...
	$image_result=image_process("epaper","edit", "0", "0");
		...
		{
			  $insertSQL = sprintf("UPDATE file_set SET file_name=%s, file_link1=%s, file_link2=%s WHERE file_id=%s" ,
  ...
  $updateGoTo = "epaper_edit.php?d_id=" . $row_RecImage['file_d_id'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
