...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE member_set SET m_name=%s, m_password=%s, m_gender=%s, m_content=%s, m_sn=%s, m_fname=%s, m_phone=%s, m_cellphone=%s, m_email=%s, m_item=%s,  m_faddress=%s, m_fzip=%s, m_fcity=%s, m_fcanton=%s, m_address=%s, m_zip=%s, m_city=%s, m_canton=%s, m_area=%s, m_map=%s, m_active=%s, m_date=%s WHERE m_id=%s",
  ...
  $updateGoTo = "farmer_list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    $updateGoTo .= (strpos($updateGoTo, '?')) ? "&" : "?";
	 $updateGoTo .= $_SERVER['QUERY_STRING']."&pageNum_RecFarmer=".$_SESSION["ToPage"];
  }
...
$(function(){
  ...
  $('#zip_container').twzipcode({
		...
		areaName	:	'm_canton',
		zipName		:	'm_zip',
		zipSel		:	'<?php echo $row_RecFarmer['m_zip']; ?>',
  ...
  $('#fzip_container').twzipcode({
		...
		areaName	:	'm_fcanton',
		zipName		:	'm_fzip',
		zipSel		:	'<?php echo $row_RecFarmer['m_fzip']; ?>',
		css			:	['input_data_county', 'input_data_county', 'input_data_zip']
  });
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="30%" class="list_title">修改農友資料</td>
          <td width="70%">&nbsp;</td>
        </tr>
      </table>
  		...
  		<tr>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                 ...
                 <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">農友姓名</td>
          	     <td width="532"><input name="m_name" type="text" class="table_data" id="m_name" value="<?php echo $row_RecFarmer['m_name']; ?>" size="50">
          	       <input name="m_id" type="hidden" class="table_data" id="m_id" value="<?php echo $row_RecFarmer['m_id']; ?>" /></td>
              ...
              <tr>
                ...
                <td><input name="m_password" type="text" class="table_data" id="m_password" value="<?php echo $row_RecFarmer['m_password']; ?>" size="50" /></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <tr>
                 <td align="center" bgcolor="#e5ecf6" class="table_col_title">性別</td>
          	     <td><select name="m_gender" class="table_data" id="m_gender">
<option value="1" <?php if (!(strcmp(1, $row_RecFarmer['m_gender']))) {echo "selected=\"selected\"";} ?>>先生</option><option value="0" <?php if (!(strcmp(0, $row_RecFarmer['m_gender']))) {echo "selected=\"selected\"";} ?>>女士</option>
                                  </select></td>
        	     <td bgcolor="#e5ecf6">&nbsp;</td>
      	      </tr>
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">農友簡介</td>
                <td><textarea name="m_content" cols="50" rows="10" class="table_data tiny" id="m_content"><?php echo $row_RecFarmer['m_content']; ?></textarea></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">綠生生產履歷編號</td>
                <td><input name="m_sn" type="text" class="table_data" id="m_sn" value="<?php echo $row_RecFarmer['m_sn']; ?>" size="50"></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">產銷班或農場名稱</td>
                <td><input name="m_fname" type="text" class="table_data" id="m_fname" value="<?php echo $row_RecFarmer['m_fname']; ?>" size="50" /></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <tr>
                 <td align="center" bgcolor="#e5ecf6" class="table_col_title">聯絡電話</td>
          	     <td><input name="m_phone" type="text" class="table_data" id="m_phone" value="<?php echo $row_RecFarmer['m_phone']; ?>" size="50" /></td>
        	     <td bgcolor="#e5ecf6">&nbsp;</td>
      	      </tr>
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">行動電話</td>
                <td><input name="m_cellphone" type="text" class="table_data" id="m_cellphone" value="<?php echo $row_RecFarmer['m_cellphone']; ?>" size="50" /></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">電子信箱</td>
                <td><input name="m_email" type="text" class="table_data" id="m_email" value="<?php echo $row_RecFarmer['m_email']; ?>" size="50"></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">主要生產項目</td>
                <td><input name="m_item" type="text" class="table_data" id="m_item" value="<?php echo $row_RecFarmer['m_item']; ?>" size="50" /></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><input name="m_faddress" type="text" class="table_data" id="m_faddress" value="<?php echo $row_RecFarmer['m_faddress']; ?>" size="50" /></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">地址</td>
                <td><div id="zip_container"></div></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">&nbsp;</td>
                <td><input name="m_address" type="text" class="table_data" id="m_address" value="<?php echo $row_RecFarmer['m_address']; ?>" size="50" /></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">栽培總面積</td>
                <td><input name="m_area" type="text" class="table_data" id="m_area" value="<?php echo $row_RecFarmer['m_area']; ?>" size="50" /></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">google map cade</td>
                <td><textarea name="m_map" cols="80" rows="10" class="table_data" id="m_map"><?php echo $row_RecFarmer['m_map']; ?></textarea></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
                <?php if ($totalRows_RecPImage > 0) { // Show if recordset not empty ?>
                  <tr>
                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">目前個人照片</td>
                    <td><?php do { ?>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="100" rowspan="2" align="center"><a href="../<?php echo $row_RecPImage['file_link1']; ?>" class="fancyboxImg" rel="group" title="<?php echo $row_RecPImage['file_title']; ?>"><img src="../<?php echo $row_RecPImage['file_link2']; ?>" alt="" class="image_frame"/></a></td>
                          ...
                          <tr>
                            <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecPImage['file_id']; ?>&type=personal" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecPImage['file_id']; ?>&type=personal" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                            <td align="center">&nbsp;</td>
                                </tr>
                        </table>
             ...
             <?php if ($totalRows_RecPImage == 0) { // Show if recordset empty ?>
              <tr>
  ...
  <p>上傳個人照片</p>
              ...
              <tr>
                 <td align="center" bgcolor="#e5ecf6" class="table_col_title">加入時間</td>
          	     <td><input name="m_date" type="text" class="table_data" id="m_date" value="<?php echo $row_RecFarmer['m_date']; ?>" size="50"></td>
        	     <td bgcolor="#e5ecf6">&nbsp;</td>
      	      </tr>
              <tr>
                ...
                <td><label>
                  <select name="m_active" class="table_data" id="m_active">
                    <?php  if($row_RecFarmer['m_active']!="0" && $row_RecFarmer['m_active']!="1"){ ?>
                    <option value="<?php echo $row_RecFarmer['active']; ?>" selected="selected">未驗證</option>
                    <?php }else{ ?>
                    <option value="0" <?php if (!(strcmp(0, $row_RecFarmer['m_active']))) {echo "selected=\"selected\"";} ?>>不可使用</option>
                    <option value="1" <?php if (!(strcmp(1, $row_RecFarmer['m_active']))) {echo "selected=\"selected\"";} ?>>可使用</option>
                    <?php } ?>
                    </select>
                  </label></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
