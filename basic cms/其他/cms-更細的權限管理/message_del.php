...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="20%" class="list_title">刪除產品留言訊息</td>
            <td width="80%"><span class="no_data">確定刪除以下產品留言訊息?</span></td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="3">
            	<tr>
                	<td width="250" align="center" bgcolor="#e5ecf6" class="table_col_title">留言產品</td>
          	    	<td><label class="table_data"><?php echo $row_RecMessage['d_title']; ?></label></td>
          	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	    	</tr>
                <tr>
                  <td align="center" bgcolor="#e5ecf6" class="table_col_title">更新時間</td>
                  <td class="table_data" style="word-break:break-all"><?php echo $row_RecMessage['d_date']; ?></td>
...
?>
        ...
        <tr>
         	<td align="center"><span class="table_data">
