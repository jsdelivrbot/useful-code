  		...
  		<tr>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                ...
                <tr>
                  ...
                  <td><span class="cart">
                    <textarea name="m_content" cols="100" rows="20" class="table_data" id="m_content"></textarea>
                  </span></td>
                  <td bgcolor="#e5ecf6" class="table_col_title">&nbsp;</td>
                </tr>
                <tr>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
	...
	$insertSQL = sprintf("INSERT INTO message_set (m_content, m_name, m_d_id, m_date, m_rem_id, m_type) VALUES (%s, %s, %s, NOW(), %s, 'repost')",
