...
if(!in_array(5,$_SESSION['MM_Limit']['a4'])){
	header("Location: productsT_list.php");
}
...
$colname_RecProductsT = "-1";
if (isset($_GET['term_id'])) {
  $colname_RecProductsT = $_GET['term_id'];
}
mysql_select_db($database_connect2data, $connect2data);
$query_RecProductsT = sprintf("SELECT * FROM terms WHERE term_id = %s", GetSQLValueString($colname_RecProductsT, "int"));
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="3" cellpadding="5">
            <tr>
              ...
              <td width="516"><input name="name" type="text" class="table_data" id="name" value="<?php echo $row_RecProductsT['name']; ?>" size="50" />
                  <input name="term_id" type="hidden" id="term_id" value="<?php echo $row_RecProductsT['term_id']; ?>" /></td>
            ...
            <tr>
              ...
              <td width="516"><label>
                <select name="term_active" class="table_data" id="term_active">
                  <option value="0" <?php if (!(strcmp(0, $row_RecProductsT['term_active']))) {echo "selected=\"selected\"";} ?>>不公佈</option>
                  <option value="1" <?php if (!(strcmp(1, $row_RecProductsT['term_active']))) {echo "selected=\"selected\"";} ?>>公佈</option>
                </select>
              </label></td>
              <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
            </tr>
