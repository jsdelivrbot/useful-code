...
if (isset($_SESSION['selected_shopProcessC'])){
	$G_selected1 = $_SESSION['selected_shopProcessC'];
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增購物說明</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
...
?>
                  ...
                  <input name="d_class1" type="hidden" id="d_class1" value="shopProcess" />
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
 ...
 if(isset($_POST['select1'])){
  ...
  $_SESSION['original_selected']=$_SESSION['selected_shopProcessC'];
  $insertGoTo = "shopProcess_list.php?selected1=".$class2."&pageNum=0&totalRows_RecShopProcess=".($_SESSION['totalRows']+1)."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
