      ...
      <?php if ($totalRows_RecConsultation > 0) { // Show if recordset not empty ?>
        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
          <tr>
            ...
            <td width="213" align="center" class="table_title">主旨</td>
            <td width="212" align="center" class="table_title">公司名稱</td>
            <td width="245" align="center" class="table_title">姓名</td>
...
//echo $totalRows_RecImage;
		?>
          ...
          <td align="center" class="table_data" ><label><a href="contactUs_edit.php?d_id=<?php echo $row_RecConsultation['d_id']; ?>"><?php echo $row_RecConsultation['d_title'];?></a></label></td>

        <td align="center" class="table_data" ><a href="contactUs_edit.php?d_id=<?php echo $row_RecConsultation['d_id']; ?>"><?php echo $row_RecConsultation['d_data1']; ?></a></td>

            <td align="center"  class="table_data"><a href="contactUs_edit.php?d_id=<?php echo $row_RecConsultation['d_id']; ?>"><?php echo $row_RecConsultation['d_data2']; ?></a></td>
