            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">管理員帳號</td>
          	    	<td><input name="user_name" type="text" class="table_data" id="user_name" value="<?php echo $row_RecAuthority['user_name']; ?>" size="50" />
...
?>
    ...
    <input name="o_user_name" type="hidden" id="o_user_name" value="<?php echo $row_RecAuthority['user_name']; ?>" />
    </form>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE admin SET user_name=%s, user_password=%s, user_level=%s, user_active=%s, user_status=%s WHERE user_id=%s",
  ...
  if($_SESSION['MM_AccountUsername']==$_POST['o_user_name']){
