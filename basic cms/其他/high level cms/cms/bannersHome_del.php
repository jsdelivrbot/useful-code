                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="100" rowspan="2" align="center"><img src="../<?php echo $row_RecImageTxt['file_link2']; ?>" alt="" class="image_frame" /></td>
...
<?php
    ...
    //----------刪除Txt圖片資料到資料庫begin(在主資料前)-----

    $sql="SELECT file_link1, file_link2, file_link3, file_link4, file_link5, file_link6 FROM file_set WHERE file_type='imageTxt' AND file_d_id='".$_POST['d_id']."'";
    ...
    $deleteSQL = sprintf("DELETE FROM file_set WHERE file_type='imageTxt' AND file_d_id=%s",
               GetSQLValueString($_REQUEST['d_id'], "int"));
  
    mysql_select_db($database_connect2data, $connect2data);
    $Result1 = mysql_query($deleteSQL, $connect2data) or die(mysql_error());
    
    //----------刪除Txt圖片資料到資料庫end(在主資料前)-----
