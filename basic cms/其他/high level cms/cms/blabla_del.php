...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除雜談</td>
            <td width="70%"><span class="no_data">確定刪除以下雜談?</span></td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
  ...
  <?php
do {  
	if (!(strcmp($row_RecYears['c_id'], $row_RecBlabla['d_class2']))) {
...
?>
            	...
            	<tr>
            	  ...
            	  <td class="table_data"><?php echo $row_RecBlabla['d_title']; ?></td>
            	  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">內容</td>
            	  <td class="table_data"><?php echo $row_RecBlabla['d_content']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
              
            	<tr>
            	  <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">時間</td>
            	  <td class="table_data"><?php echo $row_RecBlabla['d_date']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
...
<?php
    ...
    while ( $row = mysql_fetch_assoc($result))
    {
	  ...
	  $deleteGoTo = "blabla_list.php?delchangeSort=1&selected1=".$_SESSION['selected_Years'];
