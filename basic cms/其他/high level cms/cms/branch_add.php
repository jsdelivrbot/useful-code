...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $new_data_num = mysql_insert_id();//找到d_id的最大值
    ...
    //$image_result=image_process("branch","add", "0", "0");"branch"
    //一般附圖  
  ...
  //----------插入檔案資料到資料庫end----------
    ...
    mysql_select_db($database_connect2data, $connect2data);
  $query_RecBanners = "SELECT * FROM data_set WHERE d_class1 = 'branch' ORDER BY d_sort ASC, d_date DESC";
  ...
  $insertGoTo = "branch_list.php".$stringLink;
  ...
  $selfLink = "branch_add.php".$stringLink;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增四季分校</td>
            <td width="70%">&nbsp;
            </td>
        </tr>
	</table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  		<tr>
              ...
              <tr>
                ...
                <td>
                    <input name="d_data1" type="text" class="table_data" id="d_data1" value="" size="50" />
                    </td>
              ...
              <tr>
                  ...
                  <td>
                    <input name="d_data2" type="text" class="table_data" id="d_data2" value="" size="50" />
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
                  ...
                  <td>
                    <input name="d_data3" type="text" class="table_data" id="d_data3" value="" size="50" />
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
                  ...
                  <td>
                    <input name="d_data4" type="text" class="table_data" id="d_data4" value="" size="50" />
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
