...
$colname_RecBranch = "-1";
if (isset($_GET['d_id'])) {
  $colname_RecBranch = $_GET['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
$query_RecBranch = sprintf("SELECT * FROM data_set WHERE d_class1 = 'branch' AND d_id = %s", GetSQLValueString($colname_RecBranch, "int"));
$RecBranch = mysql_query($query_RecBranch, $connect2data) or die(mysql_error());
$row_RecBranch = mysql_fetch_assoc($RecBranch);
$totalRows = mysql_num_rows($RecBranch);
...
$colname_RecImage = "-1";
if (isset($row_RecBranch['d_id'])) {
  $colname_RecImage = $row_RecBranch['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
...
if (isset($row_RecBranch['d_id'])) {
  $colname_RecImageCover = $row_RecBranch['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
...
$colname_RecFile = "-1";
if (isset($row_RecBranch['d_id'])) {
  $colname_RecFile = $row_RecBranch['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $Result1 = mysql_query($updateSQL, $connect2data) or die(mysql_error());
    ...
    $image_result=image_process($_FILES['image'], $_REQUEST['image_title'], "branch","add", $imagesSize[$_SESSION['nowMenu']]['IW'], $imagesSize[$_SESSION['nowMenu']]['IH']);  
    ...
    if(isset($_FILES['imageCover'])){
      ...
      $image_result = image_process($_FILES['imageCover'], $_REQUEST['imageCover_title'], "branchCover","add", $imagesSize[$_SESSION['nowMenu'].'Cover']['IW'], $imagesSize[$_SESSION['nowMenu'].'Cover']['IH']);
    ...
    if($ifFile){
      ...
      $file_result=file_process("branch","add");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">修改四季分校</td>
            <td width="70%">&nbsp;
            </td>
        </tr>
	</table>
    ...
    <div class="groupBtn">
      ...
      $reviewLink = "http://".$_SERVER['HTTP_HOST'].$nowFile."/index.php#branchAnchor";
  		...
  		<tr>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
              ...
              <tr>
                  ...
                  <td>
                    <input name="d_title_en" type="text" class="table_data" id="d_title_en" value="<?php echo $row_RecBranch['d_title_en']; ?>" size="50" />
                  </td>
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">名稱</td>
          	    	<td><input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_RecBranch['d_title']; ?>" size="50" />
          	    	  <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecBranch['d_id']; ?>" /></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	    	</tr>
              ...
              <tr>
                ...
                <td>
                    <input name="d_data1" type="text" class="table_data" id="d_data1" value="<?php echo $row_RecBranch['d_data1']; ?>" size="50" />
                    </td>
              ...
              <tr>
                  ...
                  <td>
                    <input name="d_data2" type="text" class="table_data" id="d_data2" value="<?php echo $row_RecBranch['d_data2']; ?>" size="50" />
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>

              <tr>
                  <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">傳真</td>
                  <td>
                    <input name="d_data3" type="text" class="table_data" id="d_data3" value="<?php echo $row_RecBranch['d_data3']; ?>" size="50" />
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
                  ...
                  <td>
                    <input name="d_data4" type="text" class="table_data" id="d_data4" value="<?php echo $row_RecBranch['d_data4']; ?>" size="50" />
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>

              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">google map 座標</td>
                <td><input name="d_content" type="text" class="table_data " id="d_content" size="50"  value="<?php echo $row_RecBranch['d_content']; ?>" /></td>
                <td bgcolor="#e5ecf6"><span class="note_letter">*請直接輸入地圖座標。<br />
                  例如:24.148564, 120.639480</span></td>
              </tr>

                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td><input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo ( ($row_RecBranch['d_date']=='') || (!(strcmp("0000-00-00 00:00:00", $row_RecBranch['d_date']))) ) ? date("Y-m-d H:i:s") : $row_RecBranch['d_date']; ?>" size="50"></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
                ...
                <tr>
                  ...
                  <td><label>
                    <select name="d_active" class="table_data" id="d_active">
                      <option value="1" <?php if (!(strcmp(1, $row_RecBranch['d_active']))) {echo "selected=\"selected\"";} ?>>顯示</option><option value="0" <?php if (!(strcmp(0, $row_RecBranch['d_active']))) {echo "selected=\"selected\"";} ?>>不顯示</option>
                    </select></label></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
                ...
                <tr>
                  ...
                  <td><label>
                    <select name="d_pub" class="table_data" id="d_pub">
                      <option value="1" <?php if (!(strcmp(1, $row_RecBranch['d_pub']))) {echo "selected=\"selected\"";} ?>>發佈</option><option value="0" <?php if (!(strcmp(0, $row_RecBranch['d_pub']))) {echo "selected=\"selected\"";} ?>>草稿</option>
                    </select></label></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
                ...
                <?php if ($totalRows_RecImage > 0) { // Show if recordset not empty ?>
                  <tr>
                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">目前圖片(首頁用)</td>
                    <td><?php do { ?>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
      		    ...
      		    <tr>
              		<td align="center" bgcolor="#e5ecf6" class="table_col_title"><p>上傳圖片(首頁用)</p></td>
            ...
            <?php if ($totalRows_RecImageCover > 0) { // Show if recordset not empty ?>
                  <tr>
                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">目前圖片(內頁用)</td>
                    <td><?php do { ?>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                ...
                <tr>
                  <td align="center" bgcolor="#e5ecf6" class="table_col_title"><p>上傳圖片(內頁用)</p></td>
                    <td>
...
do {
   ...
   ?>
                                    <td><table width="320" border="1" cellpadding="0" cellspacing="0" bordercolor="#666666" class="table_frame_style">
                                        ...
                                        <tr>
                                          <td align="left" class="table_no_border"><a href="branch_file_edit.php?file_id=<?php echo $row_RecFile['file_id']; ?>"><img src="image/media_edit.gif" width="16" height="16" title="修改檔案" /></a><a href="branch_file_del.php?file_id=<?php echo $row_RecFile['file_id']; ?>"><img src="image/media_delete.gif" width="16" height="16" title="刪除檔案"/></a></td>
                                        </tr>
                                    </table></td>
                                    <?php  $RecFile_endRow++;
