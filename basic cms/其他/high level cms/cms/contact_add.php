...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增聯絡方式</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  		<tr>
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
          	    	<td><input name="d_title" type="text" class="table_data" id="d_title" value="" size="70" />
          	    	  <input name="d_class1" type="hidden" id="d_class1" value="contact" /></td>
              ...
              <tr>
                  ...
                  <td>
                    <input name="d_data1" type="text" class="table_data" id="d_data1" value="" size="70" />
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
                  ...
                  <td>
                    <input name="d_data2" type="text" class="table_data" id="d_data2" value="" size="70" />
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
                  ...
                  <td>
                    <input name="d_data3" type="text" class="table_data" id="d_data3" value="" size="70" />
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
                  ...
                  <td>
                    <input name="d_data4" type="text" class="table_data" id="d_data4" value="" size="70" />
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
            	  ...
            	  <td><input name="d_class2" type="text" class="table_data " id="d_class2" size="70" /></td>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO data_set (d_title, d_content, d_class1, d_class2, d_data1, d_data2, d_data3, d_data4, d_tag_txt, d_date, d_active) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString("聯絡方式,Contact", "text"),
  ...
  $insertGoTo = "contact_list.php?pageNum_RecContact=0&totalRows_RecContact=".($_SESSION['totalRows']+1)."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
  if (isset($_SERVER['QUERY_STRING'])) {
