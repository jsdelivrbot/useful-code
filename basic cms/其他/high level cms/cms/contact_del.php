...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除聯絡方式</td>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
          	    	<td class="table_data"><?php echo $row_RecContact['d_title']; ?>
          	    	  <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecContact['d_id']; ?>" />
            	...
            	<tr>
            	  ...
            	  <td class="table_data"><?php echo nl2br($row_RecContact['d_content']); ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
              
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">地址</td>
                <td class="table_data"><?php echo $row_RecContact['d_data1']; ?></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">電話</td>
                <td class="table_data"><?php echo $row_RecContact['d_data2']; ?></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">傳真</td>
                <td class="table_data"><?php echo $row_RecContact['d_data3']; ?></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">email</td>
                <td class="table_data"><?php echo $row_RecContact['d_data4']; ?></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">google map 連結</td>
                <td class="table_data"><a href="<?php echo $row_RecContact['d_class2']; ?>" target="_blank"><?php echo $row_RecContact['d_class2']; ?></a></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>

                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td class="table_data"><?php echo $row_RecContact['d_date']; ?></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
     	      	<tr>
...
<?php
	if ((isset($_REQUEST['d_id'])) && ($_REQUEST['d_id'] != "") && (isset($_REQUEST['delsure']))) {
	  ...
	  if (isset($_SERVER['QUERY_STRING'])) {
		...
		$deleteGoTo .= $_SERVER['QUERY_STRING']."&pageNum_RecContact=".$_SESSION["ToPage"];
	  }
