...
if(!in_array(5,$_SESSION['MM_Limit']['a12'])){
	header("Location: environment2_list.php");
}
...
$colname_RecEnvironment2 = "-1";
if (isset($_GET['d_id'])) {
  $colname_RecEnvironment2 = $_GET['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
$query_RecEnvironment2 = sprintf("SELECT * FROM data_set WHERE d_class1 = 'environment2' AND d_id = %s", GetSQLValueString($colname_RecEnvironment2, "int"));
$RecEnvironment2 = mysql_query($query_RecEnvironment2, $connect2data) or die(mysql_error());
$row_RecEnvironment2 = mysql_fetch_assoc($RecEnvironment2);
$totalRows = mysql_num_rows($RecEnvironment2);
...
$colname_RecImage = "-1";
if (isset($row_RecEnvironment2['d_id'])) {
  $colname_RecImage = $row_RecEnvironment2['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
...
if (isset($row_RecEnvironment2['d_id'])) {
  $colname_RecImageCover = $row_RecEnvironment2['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
...
$colname_RecFile = "-1";
if (isset($row_RecEnvironment2['d_id'])) {
  $colname_RecFile = $row_RecEnvironment2['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE data_set SET d_title=%s, d_title_en=%s, d_content=%s, d_price1=%s, d_class2=%s, d_class6=%s, d_data1=%s, d_data2=%s, d_data3=%s, d_data4=%s, d_date=%s, d_active=%s, d_pub=%s WHERE d_id=%s",
  ...
  $Result1 = mysql_query($updateSQL, $connect2data) or die(mysql_error());
    ...
    $image_result=image_process($_FILES['image'], $_REQUEST['image_title'], "environment2","add", $imagesSize[$_SESSION['nowMenu']]['IW'], $imagesSize[$_SESSION['nowMenu']]['IH']);  
    ...
    if($ifFile){
      ...
      $file_result=file_process("environment2","add");
  ...
  $updateGoTo = "environment2_list.php";
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">修改人文的環境</td>
            <td width="70%">&nbsp;
            </td>
        </tr>
	</table>
    ...
    <div class="groupBtn">
      ...
      $reviewLink = "http://".$_SERVER['HTTP_HOST'].$nowFile."/environment1.php";
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
          	    	<td><input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_RecEnvironment2['d_title']; ?>" size="50" />
          	    	  <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecEnvironment2['d_id']; ?>" /></td>
              ...
              <tr>
                  ...
                  <td>
                    <textarea name="d_data1" cols="100" rows="20" class="table_data" id="d_data1"><?php echo $row_RecEnvironment2['d_data1']; ?></textarea>
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <textarea name="d_content" cols="100" rows="20" class="table_data" id="d_content"><?php echo $row_RecEnvironment2['d_content']; ?></textarea>
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
                ...
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td><input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo ( ($row_RecEnvironment2['d_date']=='') || (!(strcmp("0000-00-00 00:00:00", $row_RecEnvironment2['d_date']))) ) ? date("Y-m-d H:i:s") : $row_RecEnvironment2['d_date']; ?>" size="50"></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
                ...
                <tr>
                  ...
                  <td><label>
                    <select name="d_active" class="table_data" id="d_active">
                      <option value="1" <?php if (!(strcmp(1, $row_RecEnvironment2['d_active']))) {echo "selected=\"selected\"";} ?>>顯示</option><option value="0" <?php if (!(strcmp(0, $row_RecEnvironment2['d_active']))) {echo "selected=\"selected\"";} ?>>不顯示</option>
                    </select></label></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
                ...
                <tr>
                  ...
                  <td><label>
                    <select name="d_pub" class="table_data" id="d_pub">
                      <option value="1" <?php if (!(strcmp(1, $row_RecEnvironment2['d_pub']))) {echo "selected=\"selected\"";} ?>>發佈</option><option value="0" <?php if (!(strcmp(0, $row_RecEnvironment2['d_pub']))) {echo "selected=\"selected\"";} ?>>草稿</option>
                    </select></label></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
...
do {
   ...
   ?>
                                    <td><table width="320" border="1" cellpadding="0" cellspacing="0" bordercolor="#666666" class="table_frame_style">
                                        ...
                                        <tr>
                                          <td align="left" class="table_no_border"><a href="environment2_file_edit.php?file_id=<?php echo $row_RecFile['file_id']; ?>"><img src="image/media_edit.gif" width="16" height="16" title="修改檔案" /></a><a href="environment2_file_del.php?file_id=<?php echo $row_RecFile['file_id']; ?>"><img src="image/media_delete.gif" width="16" height="16" title="刪除檔案"/></a></td>
                                        </tr>
                                    </table></td>
                                    <?php  $RecFile_endRow++;
...
<?php
mysql_free_result($RecEnvironment2);
