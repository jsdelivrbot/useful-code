...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO data_set (d_title, d_title_en, d_content, d_price1, d_data1, d_data2, d_data3, d_data4, d_class1, d_class2, d_class3, d_class4, d_class6, d_date, d_active, d_pub) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString("environment4", "text"),
  ...
  $new_data_num = mysql_insert_id();//找到d_id的最大值
    ...
    //$image_result=image_process("environment4","add", "0", "0");"environment4"
    //一般附圖  
  ...
  //----------插入檔案資料到資料庫end----------
    ...
    mysql_select_db($database_connect2data, $connect2data);
  $query_RecBanners = "SELECT * FROM data_set WHERE d_class1 = 'environment4' ORDER BY d_sort ASC, d_date DESC";
  ...
  $_SESSION['original_selected']=$_SESSION['selected_branch'] = $d_class2;

    $stringLink = "?sel=".$d_class2."&pageNum=0&totalRows=".$_SESSION['totalRows']."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
  
  $insertGoTo = "environment4_list.php".$stringLink;
  ...
  $selfLink = "environment4_add.php".$stringLink;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增五校環境美學</td>
            <td width="70%">&nbsp;
            </td>
        </tr>
	</table>
    ...
    <div class="groupBtn">
      ...
      if(isset($_SESSION['listLinks']) && $_SESSION['listLinks']!=''){ 
          $reviewLink = "http://".$_SERVER['HTTP_HOST'].$nowFile."/"."environment3_1.php?sel=".$_GET['sel'];
      ?>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  		<tr>
              ...
              <tr>
                      ...
                      <td><label>
                        <select name="d_class2" id="d_class2" class="table_data">
                          ...
                          do {  
                          ?>
                          <option value="<?php echo $row_RecBranch['d_id']?>"<?php if (!(strcmp($row_RecBranch['d_id'], $sel))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecBranch['d_title_en']?></option>
                          <?php
              ...
              <tr>
               ...
               <tr>
                  ...
                  <td>
                    <textarea name="d_data1" cols="100" rows="20" class="table_data" id="d_data1"></textarea>
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <textarea name="d_content" cols="100" rows="20" class="table_data" id="d_content"></textarea>
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
        ...
        <tr>
          ...
          <?php 
            ...
            if(isset($_SESSION['listLinks']) && $_SESSION['listLinks']!=''){ 
                //$reviewLink = "..／environment3_1.php?y=".$d_class2."&m=".$d_class3;
              //$reviewLink = "http://".$_SERVER['HTTP_HOST'].$nowFile."／environment3_1.php?y=".$d_class2."&m=".$d_class3;
            ?>
              <a href="<?php echo $_SESSION['listLinks'];?>" class="btnType finishBtn">完成</a>
              <a href="<?php echo $reviewLink; ?>" class="btnType pubBtn" target="_blank">預覽</a>
            <?php 
