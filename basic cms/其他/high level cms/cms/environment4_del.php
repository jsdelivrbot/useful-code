...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除五校環境美學</td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  		<tr>
            ...
            <tr>
              <td align="center" bgcolor="#e5ecf6" class="table_col_title">分校</td>
              <td class="table_data">
                 <?php
                do {  
                  if (!(strcmp($row_RecBranch['d_id'], $row_RecEnvironment4['d_class2']))) {
                    echo $row_RecBranch['d_title_en']."年";
                  }
              ...
              <td bgcolor="#e5ecf6">&nbsp;</td>
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
          	    	<td class="table_data"><?php echo $row_RecEnvironment4['d_title']; ?>
          	    	  <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecEnvironment4['d_id']; ?>" />
              ...
              <tr>
                  ...
                  <td class="table_data">
                    <?php echo nl2br($row_RecEnvironment4['d_data1']); ?>
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
                  ...
                  <td class="table_data"><?php echo nl2br($row_RecEnvironment4['d_content']); ?>
                    </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
                ...
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td class="table_data"><?php echo $row_RecEnvironment4['d_date']; ?></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
...
<?php
    ...
    //----------刪除封面圖片資料到資料庫end(在主資料前)-----
	  ...
	  $deleteGoTo = "environment4_list.php?delchangeSort=1&sel=".$_SESSION['selected_Branch'];
