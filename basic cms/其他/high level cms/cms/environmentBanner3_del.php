...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除寬敞、舒適、安全、衛生 Banner</td>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">中文標語</td>
          	    	<td class="table_data"><?php echo $row_RecEnvironmentBanner3['d_title']; ?>
          	    	  <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecEnvironmentBanner3['d_id']; ?>" />
              ...
              <tr>
                  ...
                  <td class="table_data"><?php echo nl2br($row_RecEnvironmentBanner3['d_title_en']); ?>
                    </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
                ...
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td class="table_data"><?php echo $row_RecEnvironmentBanner3['d_date']; ?></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
...
<?php
    ...
    while ( $row = mysql_fetch_assoc($result))
    {
	  ...
	  $deleteGoTo = "environmentBanner3_list.php?delchangeSort=1";
