...
if(!in_array(5,$_SESSION['MM_Limit']['a12'])){
	header("Location: environmentBanner3_list.php");
}
...
$colname_RecEnvironmentBanner3 = "-1";
if (isset($_GET['d_id'])) {
  $colname_RecEnvironmentBanner3 = $_GET['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
$query_RecEnvironmentBanner3 = sprintf("SELECT * FROM data_set WHERE d_class1 = 'environmentBanner3' AND d_id = %s", GetSQLValueString($colname_RecEnvironmentBanner3, "int"));
$RecEnvironmentBanner3 = mysql_query($query_RecEnvironmentBanner3, $connect2data) or die(mysql_error());
$row_RecEnvironmentBanner3 = mysql_fetch_assoc($RecEnvironmentBanner3);
$totalRows = mysql_num_rows($RecEnvironmentBanner3);
...
$colname_RecImageTxt = "-1";
if (isset($_GET['d_id'])) {
  $colname_RecImageTxt = $_GET['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
$query_RecImageTxt = sprintf("SELECT * FROM file_set WHERE file_d_id = %s AND file_type = 'imageTxt'", GetSQLValueString($colname_RecImageTxt, "int"));
$RecImageTxt = mysql_query($query_RecImageTxt, $connect2data) or die(mysql_error());
$row_RecImageTxt = mysql_fetch_assoc($RecImageTxt);
$totalRows_RecImageTxt = mysql_num_rows($RecImageTxt);
...
$_SESSION['nowMenu']= "environmentBanner3";
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE data_set SET d_title=%s, d_title_en=%s, d_content=%s, d_class2=%s, d_class6=%s, d_data1=%s, d_data2=%s, d_data3=%s, d_data4=%s, d_date=%s, d_active=%s, d_pub=%s WHERE d_id=%s",
  ...
  $Result1 = mysql_query($updateSQL, $connect2data) or die(mysql_error());
    ...
    $image_result=image_process($_FILES['image'], $_REQUEST['image_title'], "environmentBanner3","add", $imagesSize[$_SESSION['nowMenu']]['IW'], $imagesSize[$_SESSION['nowMenu']]['IH']);  
    ...
    //----------插入Txt圖片資料到資料庫begin(須放入插入主資料後)----------
          
    $image_result=image_process($_FILES['imageTxt'], $_REQUEST['imageTxt_title'], "environmentBanner3".'Txt',"add", $imagesSize[$_SESSION['nowMenu'].'Txt']['IW'], $imagesSize[$_SESSION['nowMenu'].'Txt']['IH']);      
    ...
    if($ifFile){
      ...
      $file_result=file_process("environmentBanner3","add");
  ...
  //$stringLink = "?pageNum=0&totalRows=".($_SESSION['totalRows']+1)."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";

  $updateGoTo = "environmentBanner3_list.php";
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">修改寬敞、舒適、安全、衛生 Banner</td>
            <td width="70%">&nbsp;
            </td>
        </tr>
	</table>
    ...
    <div class="groupBtn">
      ...
      $reviewLink = "http://".$_SERVER['HTTP_HOST'].$nowFile."/environment3.php";
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  		<tr>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">中文標語</td>
          	    	<td><input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_RecEnvironmentBanner3['d_title']; ?>" size="50" />
          	    	  <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecEnvironmentBanner3['d_id']; ?>" /></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	    	</tr>

              <tr>
                  <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">英文標語</td>
                  <td>
                   <textarea name="d_title_en" cols="100" rows="20" class="table_data" id="d_title_en"><?php echo $row_RecEnvironmentBanner3['d_title_en']; ?></textarea>
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
                ...
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td><input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo ( ($row_RecEnvironmentBanner3['d_date']=='') || (!(strcmp("0000-00-00 00:00:00", $row_RecEnvironmentBanner3['d_date']))) ) ? date("Y-m-d H:i:s") : $row_RecEnvironmentBanner3['d_date']; ?>" size="50"></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
                ...
                <tr>
                  ...
                  <td><label>
                    <select name="d_active" class="table_data" id="d_active">
                      <option value="1" <?php if (!(strcmp(1, $row_RecEnvironmentBanner3['d_active']))) {echo "selected=\"selected\"";} ?>>顯示</option><option value="0" <?php if (!(strcmp(0, $row_RecEnvironmentBanner3['d_active']))) {echo "selected=\"selected\"";} ?>>不顯示</option>
                    </select></label></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
                ...
                <tr>
                  ...
                  <td><label>
                    <select name="d_pub" class="table_data" id="d_pub">
                      <option value="1" <?php if (!(strcmp(1, $row_RecEnvironmentBanner3['d_pub']))) {echo "selected=\"selected\"";} ?>>發佈</option><option value="0" <?php if (!(strcmp(0, $row_RecEnvironmentBanner3['d_pub']))) {echo "selected=\"selected\"";} ?>>草稿</option>
                    </select></label></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
                ...
                <?php if ($totalRows_RecImageTxt > 0) { // Show if recordset not empty ?>
                  <tr>
                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">目前文字圖片</td>
                    <td><?php do { ?>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="100" rowspan="2" align="center"><a href="../<?php echo $row_RecImageTxt['file_link1']; ?>" class="fancyboxImg" rel="group" title="<?php echo $row_RecImageTxt['file_title']; ?>"><img src="../<?php echo $row_RecImageTxt['file_link2']; ?>" alt="" class="image_frame"/></a></td>
                                    <td align="left" class="table_data">&nbsp;圖片說明：<?php echo $row_RecImageTxt['file_title']; ?></td>
                              </tr>
                          <tr>
                            <td align="left" class="table_data">&nbsp;</td>
                              </tr>
                          <tr>
                            <td align="center"><a href="image_edit.php?type=imageTxt&file_id=<?php echo $row_RecImageTxt['file_id']; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?type=imageTxt&file_id=<?php echo $row_RecImageTxt['file_id']; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                            <td align="center">&nbsp;</td>
                                </tr>
                        </table>
                        <?php } while ($row_RecImageTxt = mysql_fetch_assoc($RecImageTxt)); ?></td>
                    <td bgcolor="#e5ecf6" class="table_col_title">
                      <p class="red_letter">*<?php echo $imagesSize[$_SESSION['nowMenu'].'Txt']['note'];?></p></td>
                  </tr>
                  <?php } // Show if recordset not empty ?>
                            
          <?php if (0 && $totalRows_RecImageTxt == 0) { // Show if recordset empty ?>
              <tr>
...
do {
   ...
   ?>
                                    <td><table width="320" border="1" cellpadding="0" cellspacing="0" bordercolor="#666666" class="table_frame_style">
                                        ...
                                        <tr>
                                          <td align="left" class="table_no_border"><a href="environmentBanner3_file_edit.php?file_id=<?php echo $row_RecFile['file_id']; ?>"><img src="image/media_edit.gif" width="16" height="16" title="修改檔案" /></a><a href="environmentBanner3_file_del.php?file_id=<?php echo $row_RecFile['file_id']; ?>"><img src="image/media_delete.gif" width="16" height="16" title="刪除檔案"/></a></td>
                                        </tr>
                                    </table></td>
                                    <?php  $RecFile_endRow++;
...
<?php
mysql_free_result($RecEnvironmentBanner3);
