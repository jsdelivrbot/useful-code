...
if(!in_array(5,$_SESSION['MM_Limit']['a5'])){
	header("Location: eventsC_list.php");
}
...
$colname_RecEventsC = "-1";
if (isset($_GET['c_id'])) {
  $colname_RecEventsC = $_GET['c_id'];
}
mysql_select_db($database_connect2data, $connect2data);
$query_RecEventsC = sprintf("SELECT * FROM class_set WHERE c_id = %s", GetSQLValueString($colname_RecEventsC, "int"));
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">修改活動分類</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="3" cellpadding="5">
            <tr>
              ...
              <td width="516"><input name="c_title" type="text" class="table_data" id="c_title" value="<?php echo $row_RecEventsC['c_title']; ?>" size="50" />
                  <input name="c_id" type="hidden" id="c_id" value="<?php echo $row_RecEventsC['c_id']; ?>" /></td>
            ...
            <tr>
              ...
              <td width="516"><label>
                <select name="c_active" class="table_data" id="c_active">
                  <option value="0" <?php if (!(strcmp(0, $row_RecEventsC['c_active']))) {echo "selected=\"selected\"";} ?>>不公佈</option>
                  <option value="1" <?php if (!(strcmp(1, $row_RecEventsC['c_active']))) {echo "selected=\"selected\"";} ?>>公佈</option>
                </select>
              </label></td>
              <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
            </tr>
