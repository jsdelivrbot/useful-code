...
if(!in_array(5,$_SESSION['MM_Limit']['a3'])){
	header("Location: founderBanner_list.php");
}
...
$colname_RecFounderBanner = "-1";
if (isset($_GET['d_id'])) {
  $colname_RecFounderBanner = $_GET['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
$query_RecFounderBanner = sprintf("SELECT * FROM data_set WHERE d_class1 = 'founderBanner' AND d_id = %s", GetSQLValueString($colname_RecFounderBanner, "int"));
$RecFounderBanner = mysql_query($query_RecFounderBanner, $connect2data) or die(mysql_error());
$row_RecFounderBanner = mysql_fetch_assoc($RecFounderBanner);
$totalRows = mysql_num_rows($RecFounderBanner);
...
$_SESSION['nowMenu']= "founderBanner";
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $Result1 = mysql_query($updateSQL, $connect2data) or die(mysql_error());
    ...
    $image_result=image_process($_FILES['image'], $_REQUEST['image_title'], "founderBanner","add", $imagesSize[$_SESSION['nowMenu']]['IW'], $imagesSize[$_SESSION['nowMenu']]['IH']);  
    ...
    $image_result=image_process($_FILES['imageTxt'], $_REQUEST['imageTxt_title'], "founderBanner".'Txt',"add", $imagesSize[$_SESSION['nowMenu'].'Txt']['IW'], $imagesSize[$_SESSION['nowMenu'].'Txt']['IH']);      
    ...
    if($ifFile){
      ...
      $file_result=file_process("founderBanner","add");
  ...
  $updateGoTo = "founderBanner_list.php";
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">修改創辦人的話 Banner</td>
            <td width="70%">&nbsp;
            </td>
        </tr>
	</table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
          	    	<td><input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_RecFounderBanner['d_title']; ?>" size="50" />
          	    	  <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecFounderBanner['d_id']; ?>" /></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	    	</tr>

              <tr>
                  <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">副標題</td>
                  <td><input name="d_title_en" type="text" class="table_data" id="d_title_en" value="<?php echo $row_RecFounderBanner['d_title_en']; ?>" size="50" /></td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>

                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td><input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo ( ($row_RecFounderBanner['d_date']=='') || (!(strcmp("0000-00-00 00:00:00", $row_RecFounderBanner['d_date']))) ) ? date("Y-m-d H:i:s") : $row_RecFounderBanner['d_date']; ?>" size="50"></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
                ...
                <tr>
                  ...
                  <td><label>
                    <select name="d_active" class="table_data" id="d_active">
                      <option value="1" <?php if (!(strcmp(1, $row_RecFounderBanner['d_active']))) {echo "selected=\"selected\"";} ?>>顯示</option><option value="0" <?php if (!(strcmp(0, $row_RecFounderBanner['d_active']))) {echo "selected=\"selected\"";} ?>>不顯示</option>
                    </select></label></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
                ...
                <tr>
                  ...
                  <td><label>
                    <select name="d_pub" class="table_data" id="d_pub">
                      <option value="1" <?php if (!(strcmp(1, $row_RecFounderBanner['d_pub']))) {echo "selected=\"selected\"";} ?>>發佈</option><option value="0" <?php if (!(strcmp(0, $row_RecFounderBanner['d_pub']))) {echo "selected=\"selected\"";} ?>>草稿</option>
                    </select></label></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
                <?php } ?>
          ...
          <?php if ($totalRows_RecImageTxt == 0) { // Show if recordset empty ?>
              <tr>
...
do {
   ...
   ?>
                                    <td><table width="320" border="1" cellpadding="0" cellspacing="0" bordercolor="#666666" class="table_frame_style">
                                        ...
                                        <tr>
                                          <td align="left" class="table_no_border"><a href="founderBanner_file_edit.php?file_id=<?php echo $row_RecFile['file_id']; ?>"><img src="image/media_edit.gif" width="16" height="16" title="修改檔案" /></a><a href="founderBanner_file_del.php?file_id=<?php echo $row_RecFile['file_id']; ?>"><img src="image/media_delete.gif" width="16" height="16" title="刪除檔案"/></a></td>
                                        </tr>
                                    </table></td>
                                    <?php  $RecFile_endRow++;
...
<?php
mysql_free_result($RecFounderBanner);
