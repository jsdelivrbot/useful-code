...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除創辦人的話</td>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
          	    	<td class="table_data"><?php echo $row_RecFounder['d_title']; ?>
          	    	  <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecFounder['d_id']; ?>" />
              ...
              <tr>
                  ...
                  <td class="table_data"><?php echo $row_RecFounder['d_title_en']; ?>
                    </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
            	...
            	<tr>
            	  ...
            	  <td class="table_data"><?php echo $row_RecFounder['d_content']; ?></td>
              ...
              <tr>
                ...
                <td class="table_data">
                  <?php if (!(strcmp(1, $row_RecFounder['d_price1']))) {echo '版型1';} ?>
                  <?php if (!(strcmp(2, $row_RecFounder['d_price1']))) {echo '版型2';} ?>
                  <?php if (!(strcmp(3, $row_RecFounder['d_price1']))) {echo '版型3';} ?>
                ...
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td class="table_data"><?php echo $row_RecFounder['d_date']; ?></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
                ...
                <?php if ($totalRows_RecImageSlider > 0 && !(strcmp(1, $row_RecFounder['d_price1']))) { // Show if recordset not empty ?>
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="100" rowspan="2" align="center"><img src="../<?php echo $row_RecImageSlider['file_link2']; ?>" alt="" class="image_frame" /></td>
...
<?php
    ...
    //----------刪除目前版型1 slider圖片圖片資料到資料庫begin(在主資料前)-----

    $sql="SELECT file_link1, file_link2, file_link3, file_link4, file_link5, file_link6 FROM file_set WHERE file_type='imageSlider' AND file_d_id='".$_POST['d_id']."'";
    ...
    $deleteSQL = sprintf("DELETE FROM file_set WHERE file_type='imageSlider' AND file_d_id=%s",
               GetSQLValueString($_REQUEST['d_id'], "int"));
  
    mysql_select_db($database_connect2data, $connect2data);
    $Result1 = mysql_query($deleteSQL, $connect2data) or die(mysql_error());
    
    //----------刪除目前版型1 slider圖片圖片資料到資料庫end(在主資料前)-----
	  ...
	  $deleteGoTo = "founder_list.php?delchangeSort=1";
	  if (isset($_SERVER['QUERY_STRING'])) {
		$deleteGoTo .= (strpos($deleteGoTo, '?')) ? "&" : "?";
		$deleteGoTo .= $_SERVER['QUERY_STRING']."&pageNum_RecFounder=".$_SESSION["ToPage"];
	  }
