...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO data_set (d_title, d_title_en, d_content, d_price1, d_data1, d_data2, d_data3, d_data4, d_class1, d_class2, d_class3, d_class4, d_class6, d_date, d_active, d_pub) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString("gallery", "text"),
  ...
  $new_data_num = mysql_insert_id();//找到d_id的最大值
    ...
    //$image_result=image_process("gallery","add", "0", "0");"gallery"
    //一般附圖  
  ...
  //----------插入檔案資料到資料庫end----------
    ...
    mysql_select_db($database_connect2data, $connect2data);
  $query_RecBanners = "SELECT * FROM data_set WHERE d_class1 = 'gallery' ORDER BY d_sort ASC, d_date DESC";
  ...
  $_SESSION['original_selected']=$_SESSION['selected_year'] = $d_class2;
    ...
    $stringLink = "?selected1=".$d_class2."&selected2=".$d_class3."&pageNum=0&totalRows=".$_SESSION['totalRows']."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
  
  $insertGoTo = "gallery_list.php".$stringLink;
  ...
  $selfLink = "gallery_add.php".$stringLink;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增美術館</td>
            <td width="70%">&nbsp;
            </td>
        </tr>
	</table>
    ...
    <div class="groupBtn">
      ...
      if(isset($_SESSION['listLinks']) && $_SESSION['listLinks']!=''){ 
          $reviewLink = "http://".$_SERVER['HTTP_HOST'].$nowFile."/art.php?y=".$_GET["selected1"]."&m=".$_GET["selected2"];
      ?>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  		<tr>
              ...
              <tr>
                  ...
                  <td>
                    <input name="d_title" type="text" class="table_data" id="d_title" value="市場狂想曲" size="50" />
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
               ...
               <tr>
                  ...
                  <td>
                    <input name="d_data2" type="text" class="table_data" id="d_data2" value="賴宣翰 5歲" size="50" />
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
               ...
               <tr>
                  ...
                  <td>
                    <textarea name="d_data1" cols="100" rows="20" class="table_data" id="d_data1">我變成一個廚師要來煮義大利麵，旁邊有很多材料跟工具，今天我要做蘋果口味的義大利麵，把蘋果洗一洗、削皮再把麵....</textarea>
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <textarea name="d_content" cols="100" rows="20" class="table_data" id="d_content">我變成一個廚師要來煮義大利麵，旁邊有很多材料跟工具，今天我要做蘋果口味的義大利麵，把蘋果洗一洗、削皮再把麵煮熟，然後把蘋果跟煮熟的義大利麵攪在一起，就成功囉！</textarea>
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
                        ...
                        <td> <span class="table_data">選擇圖片：</span>
                          ...
                          <div class="radioGroupImg">
                            <label for="d_price1_1">
                              ...
                              <div class="iconGroup table_data">
                                <div class="icon_select icon_select1 icon_select4x2"></div>
                          ...
                          <div class="radioGroupImg">
                            <label for="d_price1_2">
                              ...
                              <div class="iconGroup table_data">
                                <div class="icon_select icon_select2 icon_select4x2"></div>
                          ...
                          <div class="radioGroupImg">
                            <label for="d_price1_3">
                              ...
                              <div class="iconGroup table_data">
                                <div class="icon_select icon_select3 icon_select4x2"></div>
                          ...
                          <div class="radioGroupImg">
                            <label for="d_price1_4">
                              ...
                              <div class="iconGroup table_data">
                                <div class="icon_select icon_select4 icon_select4x2"></div>
                          ...
                          <div class="radioGroupImg">
                            <label for="d_price1_5">
                              ...
                              <div class="iconGroup table_data">
                                <div class="icon_select icon_select5 icon_select4x2"></div>
                          ...
                          <div class="radioGroupImg">
                            <label for="d_price1_6">
                              ...
                              <div class="iconGroup table_data">
                                <div class="icon_select icon_select6 icon_select4x2"></div>
                          ...
                          <div class="radioGroupImg">
                            <label for="d_price1_7">
                              ...
                              <div class="iconGroup table_data">
                                <div class="icon_select icon_select7 icon_select4x2"></div>
                          ...
                          <div class="radioGroupImg">
                            <label for="d_price1_8">
                              ...
                              <div class="iconGroup table_data">
                                <div class="icon_select icon_select8 icon_select4x2"></div>
        ...
        <tr>
          ...
          <?php 
            ...
            if(isset($_SESSION['listLinks']) && $_SESSION['listLinks']!=''){ 
                //$reviewLink = "../art.php?y=".$d_class2."&m=".$d_class3;
              //$reviewLink = "http://".$_SERVER['HTTP_HOST'].$nowFile."/art.php?y=".$d_class2."&m=".$d_class3;
            ?>
              <a href="<?php echo $_SESSION['listLinks'];?>" class="btnType finishBtn">完成</a>
              <a href="<?php echo $reviewLink; ?>" class="btnType pubBtn" target="_blank">預覽</a>
            <?php 
