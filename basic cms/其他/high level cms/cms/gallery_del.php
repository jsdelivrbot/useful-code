...
if(!in_array(7,$_SESSION['MM_Limit']['a9'])){
...
if (isset($_SESSION['selected_Years'])){
  $G_selected1 = $_SESSION['selected_Years'] = $row_RecGallery['d_class2'];
}*/
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除美術館</td>
  		...
  		<tr>
            ...
            <tr>
              ...
              <td class="table_data">
                 <?php
                do {  
                  if (!(strcmp($row_RecYears['term_id'], $row_RecGallery['d_class2']))) {
           ...
           <tr>
              ...
              <td class="table_data">
                 <?php echo $row_RecGallery['d_class3']."月"; ?>
              </td>
              <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
          	    	<td class="table_data"><?php echo $row_RecGallery['d_title']; ?>
          	    	  <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecGallery['d_id']; ?>" />
               ...
               <tr>
                  ...
                  <td class="table_data">
                    <?php echo $row_RecGallery['d_data2']; ?>
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
                  ...
                  <td class="table_data">
                    <?php echo nl2br($row_RecGallery['d_data1']); ?>
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
                  ...
                  <td class="table_data"><?php echo nl2br($row_RecGallery['d_content']); ?>
                    </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
                ...
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td class="table_data"><?php echo $row_RecGallery['d_date']; ?></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
...
<?php
    ...
    //----------刪除封面圖片資料到資料庫end(在主資料前)-----
	  ...
	  $deleteGoTo = "gallery_list.php?delchangeSort=1&selected1=".$_SESSION['selected_Years'];
