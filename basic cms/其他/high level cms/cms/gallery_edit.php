...
$query_RecGallery = sprintf("SELECT * FROM data_set WHERE d_class1 = 'gallery' AND d_id = %s", GetSQLValueString($colname_RecGallery, "int"));
$RecGallery = mysql_query($query_RecGallery, $connect2data) or die(mysql_error());
$row_RecGallery = mysql_fetch_assoc($RecGallery);
$totalRows = mysql_num_rows($RecGallery);
...
if (isset($row_RecGallery['d_id'])) {
  $colname_RecImageCover = $row_RecGallery['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
...
$colname_RecFile = "-1";
if (isset($row_RecGallery['d_id'])) {
  $colname_RecFile = $row_RecGallery['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
...
if (isset($_SESSION['selected_Years'])){
  $G_sel = $_SESSION['selected_Years'] = $row_RecGallery['d_class2'];
  //echo 'G_sel = '.$G_sel;
}*/
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "gallery_list.php".$stringLink
  ;
  if (isset($_SERVER['QUERY_STRING'])) {
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">修改美術館</td>
            <td width="70%">&nbsp;
            </td>
        </tr>
	</table>
    ...
    <div class="groupBtn">
      ...
      //$reviewLink = "http://".$_SERVER['HTTP_HOST'].$nowFile."/art.php?y=".$row_RecGallery['d_class2']."&m=".$row_RecGallery['d_class3'];

      if( (isset($row_RecGallery['d_class2'])&&$row_RecGallery['d_class2']!='') && (isset($row_RecGallery['d_class3'])&&$row_RecGallery['d_class3']!='') ){
        $reviewLink = "http://".$_SERVER['HTTP_HOST'].$nowFile."/"."art.php?y=".$row_RecGallery['d_class2']."&m=".$row_RecGallery['d_class3'];
      }else{
               ...
               <td>
                  <select name="d_class2" id="d_class2" class="table_data">
                     <?php
                       do {  
                       ?>
                        <option value="<?php echo $row_RecYears['term_id']?>" <?php if (!(strcmp($row_RecYears[ 'term_id'], $row_RecGallery[ 'd_class2']))) {echo "selected='selected'";} ?>><?php echo $row_RecYears['name']?></option>
                        <?php
            ...
            <tr>
               ...
               <td>
                  <select name="d_class3" id="d_class3" class="table_data">
                     <?php 
                        for($i=1; $i<=12; $i++){
                          echo "<option value='$i'";
                          if (!(strcmp($i, $row_RecGallery['d_class3']))) {
              ...
              <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
          	    	<td><input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_RecGallery['d_title']; ?>" size="50" />
          	    	  <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecGallery['d_id']; ?>" /></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	    	</tr>
              
               <tr>
                  <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">作者</td>
                  <td>
                    <input name="d_data2" type="text" class="table_data" id="d_data2" value="<?php echo $row_RecGallery['d_data2']; ?>" size="50" />
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
                  ...
                  <td>
                    <textarea name="d_data1" cols="100" rows="20" class="table_data" id="d_data1"><?php echo $row_RecGallery['d_data1']; ?></textarea>
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <textarea name="d_content" cols="100" rows="20" class="table_data" id="d_content"><?php echo $row_RecGallery['d_content']; ?></textarea>
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
                ...
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td><input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo ( ($row_RecGallery['d_date']=='') || (!(strcmp("0000-00-00 00:00:00", $row_RecGallery['d_date']))) ) ? date("Y-m-d H:i:s") : $row_RecGallery['d_date']; ?>" size="50"></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
                                ...
                                &nbsp;圖片說明：
                                 ...
                                 <span class="coverFormat">&nbsp;封面樣式：</span><?php 
                                  if($row_RecImageCover['file_show_type']==1){
                                    echo '<div class="iconGroup table_data"><div class="icon_select icon_select4x2 icon_select1"></div><div class="icon_title">1Wx1H</div></div>';
                                  }elseif($row_RecImageCover['file_show_type']==2){
                                    echo '<div class="iconGroup table_data"><div class="icon_select icon_select4x2 icon_select2"></div><div class="icon_title">2Wx1H</div></div>';
                                  }elseif($row_RecImageCover['file_show_type']==3){
                                    echo '<div class="iconGroup table_data"><div class="icon_select icon_select4x2 icon_select3"></div><div class="icon_title">3Wx1H</div></div>';
                                  }elseif($row_RecImageCover['file_show_type']==4){
                                    echo '<div class="iconGroup table_data"><div class="icon_select icon_select4x2 icon_select4"></div><div class="icon_title">4Wx1H</div></div>';
                                  }elseif($row_RecImageCover['file_show_type']==5){
                                    echo '<div class="iconGroup table_data"><div class="icon_select icon_select4x2 icon_select5"></div><div class="icon_title">1Wx2H</div></div>';
                                  }elseif($row_RecImageCover['file_show_type']==6){
                                    echo '<div class="iconGroup table_data"><div class="icon_select icon_select4x2 icon_select6"></div><div class="icon_title">2Wx2H</div></div>';
                                  }elseif($row_RecImageCover['file_show_type']==7){
                                    echo '<div class="iconGroup table_data"><div class="icon_select icon_select4x2 icon_select7"></div><div class="icon_title">3Wx2H</div></div>';
                                  }elseif($row_RecImageCover['file_show_type']==8){
                                    echo '<div class="iconGroup table_data"><div class="icon_select icon_select4x2 icon_select8"></div><div class="icon_title">4Wx2H</div></div>';
                                  }
                                  ?>
                                 </div>
                               </div>
...
do {
   ...
   ?>
                                    <td><table width="320" border="1" cellpadding="0" cellspacing="0" bordercolor="#666666" class="table_frame_style">
                                        ...
                                        <tr>
                                          <td align="left" class="table_no_border"><a href="gallery_file_edit.php?file_id=<?php echo $row_RecFile['file_id']; ?>"><img src="image/media_edit.gif" width="16" height="16" title="修改檔案" /></a><a href="gallery_file_del.php?file_id=<?php echo $row_RecFile['file_id']; ?>"><img src="image/media_delete.gif" width="16" height="16" title="刪除檔案"/></a></td>
                                        </tr>
                                    </table></td>
                                    <?php  $RecFile_endRow++;
