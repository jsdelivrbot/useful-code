...
$query_RecUser = sprintf("SELECT user_id, user_name, user_level, user_limit, user_active FROM `admin` WHERE user_name = %s AND user_status='active'", GetSQLValueString($colname_RecUser, "text"));
