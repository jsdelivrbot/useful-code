...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {  
 ...
 $d_data3	= checkV('d_data3');
  ...
  $insertSQL = sprintf("INSERT INTO data_set (d_title, d_title_en, d_content, d_class1, d_class2, d_tag, d_class3, d_data1, d_data2, d_data3, d_date, d_active, d_pub) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
