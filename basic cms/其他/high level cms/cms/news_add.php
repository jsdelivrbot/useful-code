...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增最新消息</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <div class="groupBtn">
      ...
      if(isset($_SESSION['listLinks']) && $_SESSION['listLinks']!=''){ 
          $reviewPage = "news_detail.php?id=".$_GET['now_d_id'];
...
echo $date->format("Y");*/
  ...
  $insertSQL = sprintf("INSERT INTO data_set (d_title, d_content, d_class1, d_class2, d_price1, d_date, d_active, d_pub) VALUES (%s, %s, 'news', %s, %s, %s, %s, %s)",
  ...
  $_SESSION['original_selected']=$_SESSION['selected_newsC'] = $d_class2;
  
  $stringLink = "?selected1=".$d_class2."&pageNum=0&totalRows=".$_SESSION['totalRows']."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
  
  $insertGoTo = "news_list.php".$stringLink;
	
	
	
  /*$_SESSION['original_selected']=$_SESSION['selected_newsC'] = $d_class2;
  $insertGoTo = "news_list.php?selected1=".$d_class2."&pageNum=0&totalRows=".($_SESSION['totalRows']+1)."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";*/
