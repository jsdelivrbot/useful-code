...
?>
              ...
              <tr>
                ...
                <td class="table_data">
                  <?php if (!(strcmp(1, $row_RecNews['d_price1']))) {echo '版型1';} ?>
                  <?php if (!(strcmp(2, $row_RecNews['d_price1']))) {echo '版型2';} ?>
...
<?php
    ...
    while ( $row = mysql_fetch_assoc($result))
    {
	  ...
	  $deleteGoTo = "news_list.php?delchangeSort=1&selected1=".$_SESSION['selected_NewsC'];
