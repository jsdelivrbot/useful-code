...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增提名及評選分類</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">分類名稱</td>
          	    	<td width="532"><input name="name" type="text" class="table_data" id="name" size="50">
          	    	  <input name="c_parent" type="hidden" id="c_parent" value="nominationT" /></td>
...
<?php
  ...
  $Result1 = mysql_query($insertSQL, $connect2data) or die(mysql_error());
	...
	$insertSQL = sprintf("INSERT INTO term_taxonomy (term_id, description, taxonomy) VALUES (%s, %s, %s)",
                       ...
                       GetSQLValueString('nominationT', "text"));
  ...
  $_SESSION['totalRows'] = $totalRows_RecNominationT;
	
   
  $insertGoTo = "nominationT_list.php?pageNum=0&totalRows_RecNominationT=".$_SESSION['totalRows']."&changeSort=1&now_term_id=".$new_data_num."&change_num=1";
  if (isset($_SERVER['QUERY_STRING'])) {
