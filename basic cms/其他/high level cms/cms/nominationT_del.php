...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除提名及評選分類</td>
            <td width="70%"><span class="no_data">確定刪除以下提名及評選分類?</span></td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">分類名稱</td>
          	    	<td width="532" class="table_data"><?php echo $row_RecNominationT['name']; ?>
          	    	  <input name="term_id" type="hidden" id="term_id" value="<?php echo $row_RecNominationT['term_id']; ?>" />
...
<?php
	if ((isset($_REQUEST['term_id'])) && ($_REQUEST['term_id'] != "") && (isset($_REQUEST['delsure']))) {
	  ...
	  $deleteGoTo = "nominationT_list.php?delchangeSort=1";
