...
//fclose($fp); 
		...
		if(file_exists($videoLink))
		{
			...
			if($image_type=="jpg" || $image_type=="gif" || $image_type=="bmp" || $image_type=="png" || $image_type=="tif")
			{
						...
						//copy($_FILES['image']['tmp_name'][$j] , $this_image_path2 );
						copy($videoLink , $this_image_path4 );
						//echo $this_path;
						//$exec_str="convert -resize 130x130 ".$_FILES[image][tmp_name][$j]." ../".$this_path2;						
						reportImagesResize_4($this_image_path4,$this_image_path4,$destW,$destH);*/
						...
						//copy($_FILES['image']['tmp_name'][$j] , $this_image_path2 );
						copy($videoLink , $this_image_path5 );
						//echo $this_path;
						//$exec_str="convert -resize 130x130 ".$_FILES[image][tmp_name][$j]." ../".$this_path2;						
						reportImagesResize_4($this_image_path5,$this_image_path5,$destW,$destH);*/
						...
						/*if(isset($description)&&$description!=''){
							$all_image_name[1]['description'] = $description;	
						}else{
							$all_image_name[1]['description'] = NULL;
						}*/
