...
if (isset($_SESSION['selected_publicationsT'])){
	$G_sel = $_SESSION['selected_publicationsT'] = $row_RecPublications['d_class2'];
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除出版品</td>
            <td width="70%"><span class="no_data">確定刪除以下出版品?</span></td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
...
do {
	...
	if (in_array($row_RecPublicationsT['term_id'], $selA)){
		echo '<li class="search-choice"><span>'.$row_RecPublicationsT['name'].'</span></li>';
	}
...
?>
            	...
            	<tr>
            	  ...
            	  <td class="table_data"><?php echo $row_RecPublications['d_title']; ?></td>
            	  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">內容</td>
            	  <td class="table_data"><?php echo $row_RecPublications['d_content']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
                <tr>
                  <td align="center" bgcolor="#e5ecf6" class="table_col_title">時間</td>
                  <td class="table_data"><?php echo $row_RecPublications['d_date']; ?></td>
                  <td bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
   ...
   ?>
                                    <td><table width="320" border="1" cellpadding="0" cellspacing="0" bordercolor="#666666" class="table_frame_style">
                                        ...
                                        <tr>
                                          ...
                                          <span class="table_data"><?php echo $row_RecFile['file_title']; ?></span></td>
                                        </tr>
                                    </table></td>
                                    <?php  $RecFile_endRow++;
...
<?php
    ...
    //----------刪除檔案資料到資料庫begin(在主資料前)-------------------
	  ...
	  $deleteGoTo = "publications_list.php?delchangeSort=1&sel=".$G_sel;
