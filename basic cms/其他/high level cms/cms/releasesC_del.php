...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除專輯分類</td>
            <td width="70%"><span class="no_data">確定刪除以下專輯分類?</span></td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">分類名稱</td>
          	    	<td width="532" class="table_data"><?php echo $row_RecReleasesC['c_title']; ?>
          	    	  <input name="c_id" type="hidden" id="c_id" value="<?php echo $row_RecReleasesC['c_id']; ?>" />
...
<?php
	if ((isset($_REQUEST['c_id'])) && ($_REQUEST['c_id'] != "") && (isset($_REQUEST['delsure']))) {
	  ...
	  $deleteGoTo = "releasesC_list.php?delchangeSort=1";
