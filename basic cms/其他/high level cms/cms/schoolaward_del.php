...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除外界肯定</td>
  		...
  		<tr>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	...
            	<tr>
                  ...
                  <td class="table_data"><?php echo $row_RecSchoolaward['d_title_en']; ?>
                  </td>
              ...
              <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">名稱</td>
          	    	<td class="table_data"><?php echo $row_RecSchoolaward['d_title']; ?>
          	    	  <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecSchoolaward['d_id']; ?>" />
              ...
              <tr>
                ...
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td class="table_data"><?php echo $row_RecSchoolaward['d_date']; ?></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
...
<?php
    ...
    while ( $row = mysql_fetch_assoc($result))
    {
	  ...
	  $deleteGoTo = "schoolaward_list.php?delchangeSort=1";
