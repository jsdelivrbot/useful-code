...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO data_set (d_title, d_title_en, d_content, d_data1, d_data2, d_data3, d_data4, d_class1, d_class2, d_class6, d_date, d_active, d_pub) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString("schooleducationBanner", "text"),
  ...
  $new_data_num = mysql_insert_id();//找到d_id的最大值
    ...
    //$image_result=image_process("schooleducationBanner","add", "0", "0");"schooleducationBanner"
    //一般附圖  
    ...
    //文字附圖  
    $image_result=image_process($_FILES['imageTxt'], $_REQUEST['imageTxt_title'], 'schooleducationBannerTxt',"add", $imagesSize[$_SESSION['nowMenu'].'Txt']['IW'], $imagesSize[$_SESSION['nowMenu'].'Txt']['IH']);      
  ...
  //----------插入檔案資料到資料庫end----------
    ...
    mysql_select_db($database_connect2data, $connect2data);
  $query_RecBanners = "SELECT * FROM data_set WHERE d_class1 = 'schooleducationBanner' ORDER BY d_sort ASC, d_date DESC";
  ...
  $insertGoTo = "schooleducationBanner_list.php".$stringLink;
  ...
  $selfLink = "schooleducationBanner_add.php".$stringLink;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增四季教育學院 Banner</td>
            <td width="70%">&nbsp;
            </td>
        </tr>
	</table>
