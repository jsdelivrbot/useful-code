...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除幼兒接送 Banner</td>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
          	    	<td class="table_data"><?php echo $row_RecShuttleBanner['d_title']; ?>
          	    	  <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecShuttleBanner['d_id']; ?>" />
              ...
              <tr>
                  ...
                  <td class="table_data"><?php echo $row_RecShuttleBanner['d_title_en']; ?>
                    </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
                ...
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td class="table_data"><?php echo $row_RecShuttleBanner['d_date']; ?></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
...
<?php
    ...
    while ( $row = mysql_fetch_assoc($result))
    {
	  ...
	  $deleteGoTo = "shuttleBanner_list.php?delchangeSort=1";
