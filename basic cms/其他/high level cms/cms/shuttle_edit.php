...
if(!in_array(5,$_SESSION['MM_Limit']['a7'])){
	header("Location: shuttle_list.php");
}
...
$colname_RecShuttle = "-1";
if (isset($_GET['d_id'])) {
  $colname_RecShuttle = $_GET['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
$query_RecShuttle = sprintf("SELECT * FROM data_set WHERE d_class1 = 'shuttle' AND d_id = %s", GetSQLValueString($colname_RecShuttle, "int"));
$RecShuttle = mysql_query($query_RecShuttle, $connect2data) or die(mysql_error());
$row_RecShuttle = mysql_fetch_assoc($RecShuttle);
$totalRows = mysql_num_rows($RecShuttle);
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $Result1 = mysql_query($updateSQL, $connect2data) or die(mysql_error());
    ...
    $image_result=image_process($_FILES['image'], $_REQUEST['image_title'], "shuttle","add", $imagesSize[$_SESSION['nowMenu']]['IW'], $imagesSize[$_SESSION['nowMenu']]['IH']);  
    ...
    if($ifFile){
      ...
      $file_result=file_process("shuttle","add");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">修改幼兒接送</td>
            <td width="70%">&nbsp;
            </td>
        </tr>
	</table>
  		...
  		<tr>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
              ...
              <tr>
                  ...
                  <td><input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_RecShuttle['d_title']; ?>" size="50" />
                    <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecShuttle['d_id']; ?>" /></td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>

              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">內容</td>
                <td><textarea name="d_content" cols="100" rows="20" class="table_data tiny" id="d_content"><?php echo $row_RecShuttle['d_content']; ?></textarea></td>
                ...
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td><input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo ( ($row_RecShuttle['d_date']=='') || (!(strcmp("0000-00-00 00:00:00", $row_RecShuttle['d_date']))) ) ? date("Y-m-d H:i:s") : $row_RecShuttle['d_date']; ?>" size="50"></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
                ...
                <tr>
                  ...
                  <td><label>
                    <select name="d_active" class="table_data" id="d_active">
                      <option value="1" <?php if (!(strcmp(1, $row_RecShuttle['d_active']))) {echo "selected=\"selected\"";} ?>>顯示</option><option value="0" <?php if (!(strcmp(0, $row_RecShuttle['d_active']))) {echo "selected=\"selected\"";} ?>>不顯示</option>
                    </select></label></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
                ...
                <tr>
                  ...
                  <td><label>
                    <select name="d_pub" class="table_data" id="d_pub">
                      <option value="1" <?php if (!(strcmp(1, $row_RecShuttle['d_pub']))) {echo "selected=\"selected\"";} ?>>發佈</option><option value="0" <?php if (!(strcmp(0, $row_RecShuttle['d_pub']))) {echo "selected=\"selected\"";} ?>>草稿</option>
                    </select></label></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
                <?php } ?>
...
do {
   ...
   ?>
                                    <td><table width="320" border="1" cellpadding="0" cellspacing="0" bordercolor="#666666" class="table_frame_style">
                                        ...
                                        <tr>
                                          <td align="left" class="table_no_border"><a href="shuttle_file_edit.php?file_id=<?php echo $row_RecFile['file_id']; ?>"><img src="image/media_edit.gif" width="16" height="16" title="修改檔案" /></a><a href="shuttle_file_del.php?file_id=<?php echo $row_RecFile['file_id']; ?>"><img src="image/media_delete.gif" width="16" height="16" title="刪除檔案"/></a></td>
                                        </tr>
                                    </table></td>
                                    <?php  $RecFile_endRow++;
