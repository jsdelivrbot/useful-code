...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $new_data_num = mysql_insert_id();//找到d_id的最大值
    ...
    //$image_result=image_process("story","add", "0", "0");"story"
    //一般附圖  
  ...
  //----------插入檔案資料到資料庫end----------
    ...
    mysql_select_db($database_connect2data, $connect2data);
  $query_RecBanners = "SELECT * FROM data_set WHERE d_class1 = 'story' ORDER BY d_sort ASC, d_date DESC";
  ...
  $insertGoTo = "story_list.php".$stringLink;
  ...
  $selfLink = "story_add.php".$stringLink;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增四季LOGO</td>
            <td width="70%">&nbsp;
            </td>
        </tr>
	</table>
