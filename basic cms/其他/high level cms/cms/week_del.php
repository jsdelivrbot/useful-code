...
$query_RecWeek = sprintf("SELECT * FROM data_set WHERE d_id = %s", GetSQLValueString($colname_RecWeek, "int"));
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除唐獎週</td>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">名稱</td>
          	    	<td class="table_data"><?php echo $row_RecWeek['d_title']; ?>
          	    	  <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecWeek['d_id']; ?>" />
              ...
              <tr>
                ...
                <td class="table_data"><?php echo $row_RecWeek['d_title_en']; ?></td>
              ...
              ?>
                ...
                <tr>
                  ...
                  <td class="table_data"><?php echo $row_RecTabs['tab_content']; ?></td>
                  <td width="250" bgcolor="#e5ecf6"></td>
                </tr>
              ...
              ?>
                ...
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td class="table_data"><?php echo date("Y-m-d", strtotime($row_RecWeek['d_date'])); ?></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
     	      	<tr>
...
<?php
    ...
    //----------刪除動態頁籤資料end----------
	  ...
	  $deleteGoTo = "week_list.php?delchangeSort=1";
	  if (isset($_SERVER['QUERY_STRING'])) {
		$deleteGoTo .= (strpos($deleteGoTo, '?')) ? "&" : "?";
		$deleteGoTo .= $_SERVER['QUERY_STRING']."&pageNum_RecWeek=".$_SESSION["ToPage"];
	  }
