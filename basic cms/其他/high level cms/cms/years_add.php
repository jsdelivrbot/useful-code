...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">年份</td>
            <td width="70%">&nbsp;</td>
        </tr>
  </table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td>
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
              ...
              <tr>
                  ...
                  <td>
                      <textarea name="description" cols="100" rows="20" class="table_data" id="description"></textarea>
                    </td>
...
<?php
  ...
  mysql_select_db($database_connect2data, $connect2data);
  $sql = "SELECT * FROM terms AS T NATURAL JOIN term_taxonomy AS TT WHERE TT.taxonomy='years' ORDER BY term_sort ASC, term_id DESC";
  $RecYears = mysql_query($sql, $connect2data) or die(mysql_error());
  $totalRows_RecYears = mysql_num_rows($RecYears);

  $_SESSION['totalRows'] = $totalRows_RecYears;

  $insertGoTo = "years_list.php?pageNum=0&totalRows_RecYears=".$_SESSION['totalRows']."&changeSort=1&now_term_id=".$new_data_num."&change_num=1";
  if (isset($_SERVER['QUERY_STRING'])) {
