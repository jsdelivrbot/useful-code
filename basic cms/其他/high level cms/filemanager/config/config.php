...
//    |   |   |   |   |- plugin.min.js
require_once('../Connections/config_set.php');
$base_url =
	// Get HTTP/HTTPS
	...
	//指向網址後需改成 $upload_dir = '/source/';
$upload_dir = $filePath.'/source/'; // path from base_url to base of upload folder (with start and final /)
