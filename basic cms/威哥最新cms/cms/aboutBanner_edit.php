...
$query_RecAboutBanner = sprintf("SELECT * FROM data_set WHERE d_id = %s AND d_class1 = 'aboutBanner'", GetSQLValueString($colname_RecAboutBanner, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $Result1 = mysql_query($updateSQL, $connect2data) or die(mysql_error());
    ...
    $image_result=image_process($_FILES['imageMobile'], $_REQUEST['imageMobile_title'], 'aboutBanner'.'Mobile',"add", $imagesSize[$_SESSION['nowMenu'].'Mobile']['IW'], $imagesSize[$_SESSION['nowMenu'].'Mobile']['IH']);      
  ...
  $updateGoTo = "aboutBanner_list.php?totalRows=".$_SESSION['totalRows']."&pageNum=".$_SESSION["ToPage"];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">修改關於我們banner</td>
            <td width="70%">&nbsp;
            </td>
        </tr>
	</table>
  		...
  		<tr>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
              ...
              <tr>
                  ...
                  <td>
                  <input name="d_title_en" type="text" class="table_data" id="d_title_en" value="<?php echo $row_RecAboutBanner['d_title_en']; ?>" size="50" />
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
                  ...
                  <td>
                    <input name="d_class2" type="text" class="table_data" id="d_class2" value="<?php echo $row_RecAboutBanner['d_class2']; ?>" size="70" />
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <?php } ?>
