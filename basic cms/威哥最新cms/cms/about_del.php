...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除關於我們</td>
  		...
  		<tr>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	...
            	<tr>
            	  ...
            	  <td class="table_data"><?php echo $row_RecAbout['d_content']; ?></td>
...
<?php
    ...
    //----------刪除圖片資料到資料庫end(在主資料前)-----
	  ...
	  if (isset($_SERVER['QUERY_STRING'])) {
		...
		$deleteGoTo .= $_SERVER['QUERY_STRING']."&pageNum_RecAbout=".$_SESSION["ToPage"];
	  }
