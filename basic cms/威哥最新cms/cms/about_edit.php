...
$query_RecAbout = sprintf("SELECT * FROM data_set WHERE d_id = %s", GetSQLValueString($colname_RecAbout, "int"));
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">修改關於我們</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
          	    	<td><input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_RecAbout['d_title']; ?>" size="70" />
              ...
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">合作洽談內容</td>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $Result1 = mysql_query($updateSQL, $connect2data) or die(mysql_error());
	...
	if(0){
  	//----------插入圖片資料到資料庫begin(須放入插入主資料後)----------
		...
		//$image_result=image_process("about","add", "0", "0");
  ...
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    $updateGoTo .= $_SERVER['QUERY_STRING']."&pageNum_RecAbout=".$_SESSION["ToPage"];
  }
