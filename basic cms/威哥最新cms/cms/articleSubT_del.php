...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除文章分類</td>
            <td width="70%"><span class="no_data">確定刪除以下文章分類?</span></td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
              ...
              <tr>
                      ...
                      <?php
                        do {
                          ...
                          if (in_array($row_RecArticleT['term_id'], $selA)){
                            echo '<li class="search-choice"><span>'.$row_RecArticleT['name'].' '.$row_RecArticleT['name_en'].'</span></li>';
                          }
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">子分類名稱</td>
          	    	<td width="532" class="table_data"><?php echo $row_RecArticleSubT['name']; ?>
          	    	  <input name="term_id" type="hidden" id="term_id" value="<?php echo $row_RecArticleSubT['term_id']; ?>" />
          	    	  <input name="delsure" type="hidden" id="delsure" value="1" /></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	    	</tr>
              <tr>
                  <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">子分類英文名稱</td>
                  <td width="532" class="table_data"><?php echo $row_RecArticleSubT['name_en']; ?></td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
            </table>
            </td>
...
<?php
    ...
    if(0){
      //main new
      $deleteSQL = sprintf("DELETE FROM data_set WHERE d_class3=%s AND d_class1='mainNews' AND d_class2='articleSubT'",
                 GetSQLValueString($_REQUEST['term_id'], "int")); 
      mysql_select_db($database_connect2data, $connect2data);
      $Result1 = mysql_query($deleteSQL, $connect2data) or die(mysql_error());
    ...
    $deleteGoTo = "articleSubT_list.php?delchangeSort=1&sel=".$G_sel;
