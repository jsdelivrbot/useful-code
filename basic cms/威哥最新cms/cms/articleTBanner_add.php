...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增分類列表頁banner</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <div class="groupBtn">
      ...
      if(isset($_SESSION['listLinks']) && $_SESSION['listLinks']!=''){ 
          ...
          if( (isset($_GET['sel'])&&$_GET['sel']!='') && (isset($_GET['now_d_id'])&&$_GET['now_d_id']!='') ){
            $reviewLink = "http://".$_SERVER['HTTP_HOST'].$nowFile."/"."articleTBanner_detail.php?cat=".$_GET['sel']."&id=".$_GET['now_d_id'];
          }else{
...
?>
                  ...
                  <td width="250" bgcolor="#e5ecf6">
                    <input name="d_class1" type="hidden" id="d_class1" value="articleTBanner" />
 ...
 $d_data3	= checkV('d_data3');
  ...
  if(0){
	 //----------插入檔案資料到資料庫begin(須放入插入主資料後)----------
		...
		$file_result=file_process("articleTBanner","add");
    ...
    $_SESSION['totalRows'] = $totalRows_RecArticleTBanner;
	
	
  $_SESSION['original_selected'] = $_SESSION['selected_articleT'] = $tagTMP;


  $stringLink = "?sel=".$tagTMP."&pageNum=0&totalRows_RecArticleTBanner=".$_SESSION['totalRows']."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
  
  $insertGoTo = "articleTBanner_list.php".$stringLink;

  //$insertGoTo = "articleTBanner_list.php?sel=".$tagTMP."&pageNum=0&totalRows_RecArticleTBanner=".$_SESSION['totalRows']."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
  ...
  //$selfLink = "articleTBanner_add.php".$stringLink;
