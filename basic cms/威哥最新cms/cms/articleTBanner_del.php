...
if (isset($_SESSION['selected_articleT'])){
	$G_sel = $_SESSION['selected_articleT'] = $row_RecArticleTBanner['d_class2'];
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除分類列表頁banner</td>
            <td width="70%"><span class="no_data">確定刪除以下分類列表頁banner?</span></td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
...
?>
            	...
            	<tr>
            	  ...
            	  <td class="table_data"><?php echo $row_RecArticleTBanner['d_title']; ?></td>
            	  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>

              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">英文標語</td>
                <td class="table_data"><?php echo $row_RecArticleTBanner['d_title_en']; ?></td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
                ...
                <tr>
                  ...
                  <td class="table_data"><?php echo $row_RecArticleTBanner['d_date']; ?></td>
                  <td bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
     	      	<tr>
...
<?php
    ...
    //----------刪除圖片資料到資料庫end(在主資料前)-----
	  ...
	  $deleteGoTo = "articleTBanner_list.php?delchangeSort=1&sel=".$G_sel;
