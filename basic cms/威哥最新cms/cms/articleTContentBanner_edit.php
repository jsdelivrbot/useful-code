...
if (isset($_SESSION['selected_articleT'])){
	$G_sel = $_SESSION['selected_articleT'] = $row_RecArticleTContentBanner['term_id'];
	//echo 'G_sel = '.$G_sel;
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">修改分類內容頁banner</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <div class="groupBtn">
      ...
      if( (isset($row_RecArticleTContentBanner['d_id'])&&$row_RecArticleTContentBanner['d_id']!='') && (isset($G_sel)&&$G_sel!='') ){

        $reviewLink = "http://".$_SERVER['HTTP_HOST'].$nowFile."/"."articleTContentBanner_detail.php?cat=".$G_sel."&id=".$_GET['d_id'];
...
?>
            	...
            	<!-- <tr>
            	  ...
            	  <td><input name="d_title" type="text" class="table_data" id="d_title" value="<?php //echo $row_RecArticleTContentBanner['d_title']; ?>" size="50" />
          	    </td>
            	  <td bgcolor="#e5ecf6">                  
              ...
              <tr>
                ...
                <td><input name="d_title_en" type="text" class="table_data" id="d_title_en" value="<?php echo $row_RecArticleTContentBanner['d_title_en']; ?>" size="50" />
                </td>
                <td bgcolor="#e5ecf6">
                  <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecArticleTContentBanner['d_id']; ?>" />
                    <input name="term_order" type="hidden" id="term_order" value="<?php echo $row_RecArticleTContentBanner['term_order']; ?>" /><?php //echo $row_RecUnitary['term_order']; ?>
                </td>
              </tr>
                ...
                <tr>
                  ...
                  <td><input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo date("Y-m-d", strtotime($row_RecArticleTContentBanner['d_date'])); ?>" size="50" /></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
                ...
                <tr>
                  ...
                  <td><label>
                    <select name="d_sale" class="table_data" id="d_sale">
                      <option value="0" <?php if (!(strcmp(0, $row_RecArticleTContentBanner['d_sale']))) {echo "selected=\"selected\"";} ?>>非進行中</option>
                      <option value="1" <?php if (!(strcmp(1, $row_RecArticleTContentBanner['d_sale']))) {echo "selected=\"selected\"";} ?>>進行中</option>
                    </select></label></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
                <?php } ?>
                <tr>
                  ...
                  <td><label>
                    <select name="d_active" class="table_data" id="d_active">
                      <option value="0" <?php if (!(strcmp(0, $row_RecArticleTContentBanner['d_active']))) {echo "selected=\"selected\"";} ?>>不公佈</option>
                      <option value="1" <?php if (!(strcmp(1, $row_RecArticleTContentBanner['d_active']))) {echo "selected=\"selected\"";} ?>>公佈</option>
                    </select>
                  </label></td>
                ...
                <tr>
                  ...
                  <td><label>
                    <select name="d_pub" class="table_data" id="d_pub">
                      <option value="1" <?php if (!(strcmp(1, $row_RecArticleTContentBanner['d_pub']))) {echo "selected=\"selected\"";} ?>>發佈</option>
                      <option value="0" <?php if (!(strcmp(0, $row_RecArticleTContentBanner['d_pub']))) {echo "selected=\"selected\"";} ?>>草稿</option>
                    </select></label></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
                <?php } ?>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
 ...
 $d_data3	= checkV('d_data3');
  ...
  $stringLink = "?sel=".$G_sel."&changeSort=1&change_num=".$_POST['term_order']."&now_d_id=".$d_id."&totalRows_RecArticleTContentBanner=".$_SESSION['totalRows']."&pageNum=".$_SESSION["ToPage"];
  
  $updateGoTo = "articleTContentBanner_list.php".$stringLink;


  //$updateGoTo = "articleTContentBanner_list.php?sel=".$class2."&selected2=".$class3."&changeSort=1&change_num=".$_POST['term_order']."&now_d_id=".$_POST['d_id']."&totalRows_RecArticleTContentBanner=".$_SESSION['totalRows']."&pageNum=".$_SESSION["ToPage"];
  //$updateGoTo = "articleTContentBanner_list.php?sel=".$G_sel."&changeSort=1&change_num=".$_POST['term_order']."&now_d_id=".$d_id."&totalRows_RecArticleTContentBanner=".$_SESSION['totalRows']."&pageNum=".$_SESSION["ToPage"];
