...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">修改文章標籤</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="3" cellpadding="5">
            <tr>
              ...
              <td width="516"><input name="name" type="text" class="table_data" id="name" value="<?php echo $row_RecArticleTag['name']; ?>" size="50" />
                  <input name="term_id" type="hidden" id="term_id" value="<?php echo $row_RecArticleTag['term_id']; ?>" /></td>
              <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
            </tr>
            <?php if(0){ ?>
            <tr>
              <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">分類英文名稱</td>
              <td width="516"><input name="name_en" type="text" class="table_data" id="name_en" value="<?php echo $row_RecArticleTag['name_en']; ?>" size="50" />
                  </td>
              <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
            </tr>
            <?php } ?>
            ...
            <tr>
              ...
              <td width="516"><label>
                <select name="term_active" class="table_data" id="term_active">
                  <option value="0" <?php if (!(strcmp(0, $row_RecArticleTag['term_active']))) {echo "selected=\"selected\"";} ?>>不公佈</option>
                  <option value="1" <?php if (!(strcmp(1, $row_RecArticleTag['term_active']))) {echo "selected=\"selected\"";} ?>>公佈</option>
                </select>
              </label></td>
              <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
            </tr>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  /*******************************************************************/
    ...
    mysql_select_db($database_connect2data, $connect2data);  
    $query_RecCheckMainNews = "SELECT * FROM data_set AS D WHERE D.d_class1='mainNews' AND D.d_class2='articleTag' AND D.d_class3='$term_id'";  
    ...
    if($totalRows_RecCheckMainNews==0){
      $insertSQL = sprintf("INSERT INTO data_set (d_title, d_class1, d_class2, d_class3, d_active, d_pub, d_sort) VALUES (%s, %s, %s, %s, 1, 0, 1)",
                         ...
                         GetSQLValueString('articleTag', "text"),
                         GetSQLValueString($term_id, "int"));
      ...
      $updateSQL = sprintf("UPDATE data_set SET d_title=%s WHERE d_class3=%s AND d_class1='mainNews' AND d_class2='articleTag'",
         GetSQLValueString($name, "text"),
         GetSQLValueString($term_id, "int"));
      ...
      $selectSQL = sprintf("SELECT d_id FROM data_set WHERE d_class3=%s AND d_class1='mainNews' AND d_class2='articleTag'",       
         GetSQLValueString($term_id, "int"));
  ...
  $updateGoTo = "articleTag_list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
