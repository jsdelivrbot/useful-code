...
if (isset($_SESSION['selected_articleT'])){
	$G_sel = $_SESSION['selected_articleT'] = $row_RecArticle['d_class2'];
}*/
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除文章</td>
            <td width="70%"><span class="no_data">確定刪除以下文章?</span></td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
  		...
  		<tr>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                  ...
                  <ul class="chosen-choices">
                    ...
                    do {
                      ...
                      if (in_array($row_RecArticleSubT['term_id'], $selA)){
                        echo '<li class="search-choice"><span>'.$row_RecArticleSubT['name'].' '.$row_RecArticleSubT['name_en'].'</span></li>';
                      }
              ...
              <tr>
                ...
                <td class="table_data">
                <?php echo $row_RecArticle['d_class5'];?>
                </td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
            	  <td class="table_data"><?php echo $row_RecArticle['d_title']; ?></td>
            	  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">簡介</td>
                <td class="table_data"><?php echo nl2br($row_RecArticle['d_data1']); ?></td>
                <td bgcolor="#e5ecf6"></td>
              </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">內文</td>
            	  <td class="table_data"><?php echo $row_RecArticle['d_content']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
              <tr>
                  ...
                  <ul class="chosen-choices">
                    ...
                    do {
                      ...
                      if (in_array($row_RecArticleTag['term_id'], $selA)){
                        echo '<li class="search-choice"><span>'.$row_RecArticleTag['name'].'</span></li>';
                      }
                ...
                <tr>
                  ...
                  <td class="table_data"><?php echo date("Y-m-d", strtotime($row_RecArticle['d_date'])); ?></td>
                  <td bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
              ...
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">最新故事封面</td>
                <td>
                  <?php do { ?>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="100" rowspan="2" align="center"><img src="../<?php echo $row_RecImageCover['file_link2']; ?>" alt="" class="image_frame" width="100"/></td>
...
<?php
	if ((isset($_REQUEST['d_id'])) && ($_REQUEST['d_id'] != "") && (isset($_REQUEST['delsure']))) {
		...
		//----------刪除ListCover圖片資料到資料庫begin(在主資料前)-----
    ...
    //----------刪除ListCover圖片資料到資料庫end(在主資料前)-----
    //----------刪除imageCover圖片資料到資料庫begin(在主資料前)-----
    ...
    //----------刪除imageCover圖片資料到資料庫end(在主資料前)-----
	  ...
	  $deleteGoTo = "article_list.php?delchangeSort=1&sel1=".$G_sel1."&sel2=".$G_sel2;
