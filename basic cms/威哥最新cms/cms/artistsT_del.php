...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除Artists</td>
            <td width="70%"><span class="no_data">確定刪除以下Artists?</span></td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">中文名稱</td>
          	    	<td width="532" class="table_data"><?php echo $row_RecArtistsT['name']; ?>
          	    	  <input name="term_id" type="hidden" id="term_id" value="<?php echo $row_RecArtistsT['term_id']; ?>" />
          	    	  <input name="delsure" type="hidden" id="delsure" value="1" /></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	    	</tr>
              <tr>
                  <td align="center" bgcolor="#e5ecf6" class="table_col_title">英文名稱</td>
                  <td class="table_data"><?php echo $row_RecArtistsT['name_en']; ?></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <tr>
                  <td align="center" bgcolor="#e5ecf6" class="table_col_title">描述</td>
                  <td class="table_data"><?php echo nl2br($row_RecArtistsT['description']); ?></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
...
<?php
    ...
    $sql="SELECT file_link1, file_link2, file_link3 FROM file_set WHERE file_type = 'artistsCover' AND file_d_id='".$_POST['term_id']."'";
    ...
    //
    //刪除圖片資料庫資料begin----
    $deleteSQL = sprintf("DELETE FROM file_set WHERE file_type = 'artistsCover' AND file_d_id=%s",
    ...
    //刪除圖片資料庫資料end----
	  ...
	  $deleteGoTo = "artistsT_list.php?delchangeSort=1";
