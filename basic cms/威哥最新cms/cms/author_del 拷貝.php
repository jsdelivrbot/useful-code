...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="300" class="list_title">刪除作者</td>
            <td width="724">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">作者帳號</td>
          	    	<td width="532" class="table_data">
          	    	  <?php echo $row_RecAuthor['user_account']; ?>
          	    	  <input name="user_id" type="hidden" id="user_id" value="<?php echo $row_RecAuthor['user_id']; ?>" />
...
<?php
	if ((isset($_REQUEST['user_id'])) && ($_REQUEST['user_id'] != "") && (isset($_REQUEST['delsure']))) {
	  ...
	  $deleteSQL = sprintf("DELETE FROM admin WHERE user_id=%s",
						   GetSQLValueString($_REQUEST['user_id'], "int"));
	  ...
	  if (isset($_SERVER['QUERY_STRING'])) {
		...
		$deleteGoTo .= $_SERVER['QUERY_STRING']."&pageNum_RecAuthor=".$_SESSION["ToPage"];
	  }
