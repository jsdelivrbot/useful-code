...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除作者</td>
            <td width="70%"><span class="no_data">確定刪除以下作者?</span></td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="3">
              ...
              <tr>
            	...
            	<tr>
            	  ...
            	  <td class="table_data"><?php echo $row_RecAuthor['user_content']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
              <tr>
                ...
                <tr>
                  ...
                  <td class="table_data"><?php echo $row_RecAuthor['user_date']; ?></td>
                  <td bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
     	      	<tr>
                  <?php if ($totalRows_RecImage > 0) { // Show if recordset not empty ?>
                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">作者圖片</td>
                    <td><?php do { ?>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
...
<?php
    ...
    $sql="SELECT file_link1, file_link2, file_link3, file_link4, file_link5, file_link6 FROM file_set WHERE file_type='imageAuthor' AND file_d_id='".$_POST['d_id']."'";
    ...
    $deleteSQL = sprintf("DELETE FROM file_set WHERE file_type='imageAuthor' AND file_d_id=%s",
    ...
    //----------刪除圖片資料到資料庫end(在主資料前)-----
	  ...
	  $deleteSQL = sprintf("DELETE FROM admin WHERE user_id=%s",
						   GetSQLValueString($_REQUEST['d_id'], "int"));
	
	  mysql_select_db($database_connect2data, $connect2data);
	  $Result1 = mysql_query($deleteSQL, $connect2data) or die(mysql_error());	  
	   
	  $deleteGoTo = "author_list.php?delchangeSort=1&sel=".$G_sel;
