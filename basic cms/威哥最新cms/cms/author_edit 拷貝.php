...
if (isset($_GET['user_id'])) {
  $colname_RecAuthor = $_GET['user_id'];
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="300" class="list_title">修改作者</td>
            <td width="724">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">作者帳號</td>
          	    	<td><input name="user_account" type="text" class="table_data" id="user_account" value="<?php echo $row_RecAuthor['user_account']; ?>" size="50" />
          	    	  <input name="user_id" type="hidden" id="user_id" value="<?php echo $row_RecAuthor['user_id']; ?>" /></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	    	</tr>
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">作者密碼</td>
          	    	<td><input name="user_password" type="password" class="table_data" id="user_password" size="50" />
          	    	  <input name="password" type="hidden" id="password" value="<?php echo $row_RecAuthor['user_password']; ?>" /></td>
          	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	    	</tr><tr>
...
?>
                ...
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">帳號是否有效</td>
          	        ...
          	        <select name="user_active" class="table_data" id="user_active">
          	          <option value="1" <?php if (!(strcmp(1, $row_RecAuthor['user_active']))) {echo "selected=\"selected\"";} ?>>有效</option>
          	          <option value="0" <?php if (!(strcmp(0, $row_RecAuthor['user_active']))) {echo "selected=\"selected\"";} ?>>無效</option>
       	            </select></label></td>
          	     	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
                        </table>
    ...
    <input name="o_user_account" type="hidden" id="o_user_account" value="<?php echo $row_RecAuthor['user_account']; ?>" />
    </form>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE admin SET user_account=%s, user_password=%s, user_level=%s, user_active=%s, user_status=%s, user_type=0 WHERE user_id=%s",
  ...
  if($_SESSION['MM_AccountUsername']==$_POST['o_user_account']){
	  ...
	  if (isset($_SERVER['QUERY_STRING'])) {
		...
		$updateGoTo .= $_SERVER['QUERY_STRING']."&pageNum_RecAuthor=".$_SESSION["ToPage"];
	  }
