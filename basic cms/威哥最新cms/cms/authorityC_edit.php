    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  		<tr>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
              ...
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">權限種類</td>
                <td><label>
                  <select name="a_type" class="table_data" id="a_type">
                    <option value="1" <?php if (!(strcmp(1, $row_RecAuthorityC['a_type']))) {echo "selected=\"selected\"";} ?>>後端管理者</option>
                    <option value="0" <?php if (!(strcmp(0, $row_RecAuthorityC['a_type']))) {echo "selected=\"selected\"";} ?>>作者</option>
                    </select>
                  </label></td>
...
?>
  ...
  <option value="0" <?php echo (in_array(0,$perm_4))?'selected="selected"':''?>>不允許</option>
                ...
                <tr>
                  <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">作者管理</td>
                  <td class="table_data">
...
?>
  ...
  <option value="0" <?php echo (in_array(0,$perm_10))?'selected="selected"':''?>>不允許</option>
                    ...
                    <div class="perm" id="perm_10">                    
                      ...
                      <?php if(0){ ?>
                      <label for="del_10">
                        <input name="del_10" type="checkbox" id="del_10" value="7" <?php echo (in_array(7,$perm_10))?'checked="checked"':''?> />
                            刪除
                        </label>
                      </div>
                      <?php } ?>
...
echo 'del_1 = '.$_POST['del_1'].'<br>';	*/
  ...
  $updateSQL = sprintf("UPDATE a_set SET a_title=%s, a_1=%s, a_2=%s, a_3=%s, a_4=%s, a_5=%s, a_6=%s, a_7=%s, a_8=%s, a_9=%s, a_10=%s, a_11=%s, a_12=%s, a_13=%s, a_14=%s, a_15=%s, a_16=%s, a_type=%s WHERE a_id=%s",
