...
$query_RecBannersHome = sprintf("SELECT * FROM data_set WHERE d_id = %s AND d_class1 = 'bannersHome'", GetSQLValueString($colname_RecBannersHome, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $Result1 = mysql_query($updateSQL, $connect2data) or die(mysql_error());
    ...
    $image_result=image_process($_FILES['imageMobile'], $_REQUEST['imageMobile_title'], 'banners'.'Mobile',"add", $imagesSize[$_SESSION['nowMenu'].'Mobile']['IW'], $imagesSize[$_SESSION['nowMenu'].'Mobile']['IH']);      
  ...
  $updateGoTo = "bannersHome_list.php?totalRows=".$_SESSION['totalRows']."&pageNum=".$_SESSION["ToPage"];
  /*if (isset($_SERVER['QUERY_STRING'])) {
  		...
  		<tr>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
              ...
              <tr>
                  ...
                  <td>
                    <input name="d_class2" type="text" class="table_data" id="d_class2" value="<?php echo $row_RecBannersHome['d_class2']; ?>" size="70" />
                  </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <?php } ?>
