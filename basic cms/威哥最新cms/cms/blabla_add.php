...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增雜談</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
...
echo $date->format("Y");*/
  ...
  $insertSQL = sprintf("INSERT INTO data_set (d_title, d_content, d_data1, d_data2, d_class1, d_class2, d_class3, d_class4, d_class5, d_date, d_active) VALUES (%s, %s, %s, %s, 'blabla', %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "blabla_list.php?selected1=".$d_class2."&pageNum=0&totalRows=".($_SESSION['totalRows']+1)."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
