...
<?php require_once('photo_process_blabla.php'); ?>
<?php
...
if(!in_array(5,$_SESSION['MM_Limit']['a8'])){
	header("Location: blabla_list.php");
}
...
$colname_RecBlabla = "-1";
if (isset($_GET['d_id'])) {
  $colname_RecBlabla = $_GET['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
$query_RecBlabla = sprintf("SELECT data_set.*, class_set.c_title as c_title FROM data_set LEFT JOIN class_set ON data_set.d_class2 =class_set.c_id WHERE d_id = %s", GetSQLValueString($colname_RecBlabla, "int"));
$RecBlabla = mysql_query($query_RecBlabla, $connect2data) or die(mysql_error());
$row_RecBlabla = mysql_fetch_assoc($RecBlabla);
$totalRows_RecBlabla = mysql_num_rows($RecBlabla);
...
mysql_select_db($database_connect2data, $connect2data);
$query_RecBlablaC = "SELECT * FROM class_set WHERE c_parent = 'blablaC' AND c_active='1' ORDER BY c_sort ASC, c_id DESC";
$RecBlablaC = mysql_query($query_RecBlablaC, $connect2data) or die(mysql_error());
$row_RecBlablaC = mysql_fetch_assoc($RecBlablaC);
$totalRows_RecBlablaC = mysql_num_rows($RecBlablaC);

//echo 'selected_Years = '.$_SESSION['selected_Years'];
/*$G_selected1 = '';
if (isset($_SESSION['selected_Years'])){
	$G_selected1 = $_SESSION['selected_Years'] = $row_RecBlabla['d_class2'];
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">修改雜談</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
...
do {  
?>
            	      <option value="<?php echo $row_RecYears['c_id']?>" <?php if (!(strcmp($row_RecYears['c_id'], $row_RecBlabla['d_class2']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecYears['c_title']?></option>
            	      <?php
...
?>
            	...
            	<tr>
            	  ...
            	  <td><input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_RecBlabla['d_title']; ?>" size="80" />
            	    </td>
            	  <td bgcolor="#e5ecf6">                  
            	...
            	<tr>
            	  ...
            	  <td class="table_data"><textarea name="d_content" cols="100" rows="20" class="table_data tiny" id="d_content"><?php echo $row_RecBlabla['d_content']; ?></textarea></td>
                ...
                <tr>
                  ...
                  <td><input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo $row_RecBlabla['d_date']; ?>" size="50" /></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
            	<tr>
            	  ...
            	  <td><label>
            	    <select name="d_active" class="table_data" id="d_active">
            	      <option value="0" <?php if (!(strcmp(0, $row_RecBlabla['d_active']))) {echo "selected=\"selected\"";} ?>>不公佈</option>
            	      <option value="1" <?php if (!(strcmp(1, $row_RecBlabla['d_active']))) {echo "selected=\"selected\"";} ?>>公佈</option>
            	      </select>
            	    </label></td>
    ...
    <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecBlabla['d_id']; ?>" />
    <input name="d_sort" type="hidden" id="d_sort" value="<?php echo $row_RecBlabla['d_sort']; ?>" />
    </form>
...
if( is_null($d_class4) ){
 ...
 //$y = substr($d_date, 0, 4);
  ...
  $Result1 = mysql_query($updateSQL, $connect2data) or die(mysql_error());
	...
	$image_result=image_process($_FILES['image'], $_REQUEST['image_title'], "blabla","add", $imagesSize[$_SESSION['nowMenu']]['IW'], $imagesSize[$_SESSION['nowMenu']]['IH']);
  ...
  //$updateGoTo = "blabla_list.php?selected1=".$class2."&selected2=".$class3."&changeSort=1&change_num=".$_POST['d_sort']."&now_d_id=".$d_id."&totalRows_RecBlabla=".$_SESSION['totalRows']."&pageNum=".$_SESSION["ToPage"];
  $updateGoTo = "blabla_list.php?selected1=".$d_class2."&changeSort=1&change_num=".$_POST['d_sort']."&now_d_id=".$d_id."&totalRows=".$_SESSION['totalRows']."&pageNum=".$_SESSION["ToPage"];
