  		...
  		<tr>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="3">
              ...
              <tr>
                ...
                <td><input name="d_data2" type="text" class="table_data" id="d_data2" size="50" value="" /></td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO data_set (d_title, d_title_en, d_content, d_price1, d_class1, d_data1, d_data2, d_date, d_active, d_pub) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  //索引與連結
  if(isset($_POST['tabReport_title']) && isset($_POST['tabReport_content'])){
    ...
    for($j=0; $j<count($tabReport_title); $j++){
      ...
      if($tabReport_title[$j]!='' && $tabReport_content[$j]!=''){
        ...
        $insertSQL = sprintf("INSERT INTO tab_set (tab_d_id, tab_type, tab_title, tab_content, tab_data1, tab_sort) VALUES (%s, %s, %s, %s, %s, %s)",
                           GetSQLValueString($new_data_num, "int"),
                           GetSQLValueString($d_class1."Report", "text"),
  ...
  if($d_price1==1){
    //版型－窄圖片版
    if(isset($_POST['tabOther1_title']) && isset($_POST['tabOther1_content'])){
      ...
      for($j=0; $j<count($tabOther1_title); $j++){
        ...
        if($tabOther1_title[$j]!='' && $tabOther1_content[$j]!=''){
          ...
          $insertSQL = sprintf("INSERT INTO tab_set (tab_d_id, tab_type, tab_title, tab_content, tab_data1, tab_sort) VALUES (%s, %s, %s, %s, %s, %s)",
                             GetSQLValueString($new_data_num, "int"),
                             GetSQLValueString($d_class1."Temp1", "text"),
    ...
    //版型－寬圖片版型
    if(isset($_POST['tabOther2_title']) && isset($_POST['tabOther2_content'])){
      ...
      for($j=0; $j<count($tabOther2_title); $j++){
        ...
        if($tabOther2_title[$j]!='' && $tabOther2_content[$j]!=''){
          ...
          $insertSQL = sprintf("INSERT INTO tab_set (tab_d_id, tab_type, tab_title, tab_content, tab_data1, tab_sort) VALUES (%s, %s, %s, %s, %s, %s)",
                             GetSQLValueString($new_data_num, "int"),
                             GetSQLValueString($d_class1."Temp2", "text"),
    ...
    //版型－綜合圖片版型
    //寬圖片
    if(isset($_POST['tabOther3_title']) && isset($_POST['tabOther3_content'])){
      ...
      for($j=0; $j<count($tabOther3_title); $j++){
        ...
        if($tabOther3_title[$j]!='' && $tabOther3_content[$j]!=''){
          ...
          $insertSQL = sprintf("INSERT INTO tab_set (tab_d_id, tab_type, tab_title, tab_content, tab_data1, tab_sort) VALUES (%s, %s, %s, %s, %s, %s)",
                             GetSQLValueString($new_data_num, "int"),
                             GetSQLValueString($d_class1."Temp3", "text"),
    ...
    //寬圖片
    //窄圖片
    if(isset($_POST['tabOther4_title']) && isset($_POST['tabOther4_content'])){
      ...
      for($j=0; $j<count($tabOther4_title); $j++){
        ...
        if($tabOther4_title[$j]!='' && $tabOther4_content[$j]!=''){
          ...
          $insertSQL = sprintf("INSERT INTO tab_set (tab_d_id, tab_type, tab_title, tab_content, tab_data1, tab_sort) VALUES (%s, %s, %s, %s, %s, %s)",
                             GetSQLValueString($new_data_num, "int"),
                             GetSQLValueString($d_class1."Temp4", "text"),
  ...
  mysql_select_db($database_connect2data, $connect2data);
    $query_RecEpaper = "SELECT * FROM data_set WHERE d_class1='epaper'";
  ...
  $_SESSION['totalRows'] = $totalRows_RecEpaper;
