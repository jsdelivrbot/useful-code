...
if (isset($_SESSION['selected_eventT'])){
	$G_sel = $_SESSION['selected_eventT'];
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增活動訊息</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <div class="groupBtn">
      ...
      if(isset($_SESSION['listLinks']) && $_SESSION['listLinks']!=''){ 
          ...
          if( (isset($_GET['sel'])&&$_GET['sel']!='') && (isset($_GET['now_d_id'])&&$_GET['now_d_id']!='') ){
            $reviewLink = "http://".$_SERVER['HTTP_HOST'].$nowFile."/"."event_detail.php?cat=".$_GET['sel']."&id=".$_GET['now_d_id'];
          }else{
...
?>
                  ...
                  <td width="250" bgcolor="#e5ecf6">
                    <input name="d_class1" type="hidden" id="d_class1" value="event" />
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
 ...
 $d_data3	= checkV('d_data3');
  ...
  $Result1 = mysql_query($updateSQL, $connect2data) or die(mysql_error());
	...
	//----------插入圖片資料到資料庫end----------
	 //----------插入檔案資料到資料庫begin(須放入插入主資料後)----------
		...
		$file_result=file_process("event","add");
    ...
    $_SESSION['totalRows'] = $totalRows_RecEvent;
	
	
  $_SESSION['original_selected'] = $_SESSION['selected_eventT'] = $tagTMP;


  $stringLink = "?sel=".$tagTMP."&pageNum=0&totalRows_RecEvent=".$_SESSION['totalRows']."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
  
  $insertGoTo = "event_list.php".$stringLink;

  //$insertGoTo = "event_list.php?sel=".$tagTMP."&pageNum=0&totalRows_RecEvent=".$_SESSION['totalRows']."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
  ...
  $selfLink = "event_add.php".$stringLink;
