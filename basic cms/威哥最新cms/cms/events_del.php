...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除活動</td>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
          	    	<td class="table_data"><?php echo $row_RecEvents['d_title']; ?>
              ...
              <tr>
                  ...
                  <td class="table_data"><?php echo $row_RecEvents['d_data1']; ?>
                    </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>

              <tr>
                  <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">活動資訊</td>
                  <td class="table_data"><?php echo $row_RecEvents['d_data2']; ?>
                    </td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
            	...
            	<tr>
            	  ...
            	  <td class="table_data"><?php echo $row_RecEvents['d_content']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>

              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">活動日期</td>
                <td class="table_data">
                  
                  <?php 
                  echo date("Y.m.d", strtotime($row_RecEvents['d_startdate']))." ~ ".date("Y.m.d", strtotime($row_RecEvents['d_enddate']));
                  ?>
                </td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
                ...
                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td class="table_data"><?php echo $row_RecEvents['d_date']; ?></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
                  ...
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="100" rowspan="2" align="center"><img src="../<?php echo $row_RecImagePoster['file_link2']; ?>" alt="" class="image_frame" /></td>
                  ...
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="100" rowspan="2" align="center"><img src="../<?php echo $row_RecImagePosterMobile['file_link2']; ?>" alt="" class="image_frame" /></td>
...
<?php
    ...
    $sql="SELECT file_link1, file_link2, file_link3, file_link4, file_link5, file_link6 FROM file_set WHERE (file_type='image' OR file_type='imagePoster' OR file_type='imagePosterMobile') AND file_d_id='".$_POST['d_id']."'";
    ...
    $deleteSQL = sprintf("DELETE FROM file_set WHERE (file_type='image' OR file_type='imagePoster' OR file_type='imagePosterMobile') AND file_d_id=%s",
    ...
    //----------刪除圖片資料到資料庫end(在主資料前)-----
	  ...
	  $deleteGoTo = "events_list.php?delchangeSort=1";
	  if (isset($_SERVER['QUERY_STRING'])) {
		$deleteGoTo .= (strpos($deleteGoTo, '?')) ? "&" : "?";
		$deleteGoTo .= $_SERVER['QUERY_STRING']."&pageNum_RecEvents=".$_SESSION["ToPage"];
	  }
