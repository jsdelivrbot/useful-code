...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增首頁影片</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
          	    	<td><input name="d_title" type="text" class="table_data" id="d_title" value="" size="70" />
          	    	  <input name="d_class1" type="hidden" id="d_class1" value="indexVideo" /></td>
...
例如，影片網址為：<br>https://www.youtube.com/watch?v=_jJNocrL_as&feature=youtu.be，<br>網址watch?v=後面則為影片碼( <b>_jJNocrL_as</b> )。</span></td>
                ...
                <tr>
                  <td align="center" bgcolor="#e5ecf6" class="table_col_title"><p>上傳手機版封面</p></td>
                    <td>
                    <table width="100%" border="0" cellpadding="2" cellspacing="2" bordercolor="#CCCCCC" class="data" id="pTableMobile">
                      <tr>
                        <td> <span class="table_data">選擇圖片：</span>
                    ...
                    <td bgcolor="#e5ecf6" class="table_col_title">
                      <p class="red_letter">*<?php echo $imagesSize[$_SESSION['nowMenu'].'Mobile']['note'];?></p>
                    </td>
                </tr>
			</table>
            </td>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if(isset($_FILES['imageMobile']) && $_FILES['imageMobile']!=''){
      ...
      for($j=1;$j<count($image_result);$j++)
      {
	    ...
	    //----------插入檔案資料到資料庫begin(須放入插入主資料後)----------
   			//echo file_process();
		if(0){	
  		$file_result=file_process("indexVideo","add");
  ...
  $totalRows = mysql_num_rows($RecIndexVideo);

  $_SESSION['totalRows'] = $totalRows;
	
  $insertGoTo = "indexVideo_list.php?pageNum_RecIndexVideo=0&totalRows_RecIndexVideo=".$_SESSION['totalRows']."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
  if (isset($_SERVER['QUERY_STRING'])) {
