...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增關鍵字與描述</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  		<tr>
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
          	    	<td><input name="d_title" type="text" class="table_data" id="d_title" value="" size="70" />
          	    	  <input name="d_class1" type="hidden" id="d_class1" value="keywords" /></td>
              ...
              <tr>
                ...
                <td><textarea name="d_class2" cols="100" rows="20" class="table_data " id="d_class2"></textarea></td>
                <td bgcolor="#e5ecf6"><span class="note_letter"></span></td>
              </tr>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  //$insertGoTo = "keywords_list.php?pageNum_RecKeywords=0&totalRows_RecKeywords=".$_SESSION['totalRows']."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
  $insertGoTo = "keywords_list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
