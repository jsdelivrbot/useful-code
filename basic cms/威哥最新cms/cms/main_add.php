...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增主頁Banner</td>
            <td width="70%">&nbsp;
            </td>
        </tr>
	</table>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO data_set (d_title, d_content, d_data1, d_data2, d_data3, d_data4, d_class1, d_date, d_active, d_pub) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($menu_is, "text"),
  ...
  $Result1 = mysql_query($insertSQL, $connect2data) or die(mysql_error());
		...
		//$image_result=image_process("main","add", "0", "0");
		//一般附圖	
  ...
  /*$insertGoTo = "main_list.php?pageNum=0&totalRows=".$_SESSION['totalRows']."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  $insertGoTo = "main_list.php".$stringLink;
  ...
  $selfLink = "main_add.php".$stringLink;
