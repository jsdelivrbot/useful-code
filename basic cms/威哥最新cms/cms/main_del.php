...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除主頁Banner</td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  		<tr>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
              ...
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">小標題</td>
                <td class="table_data"><?php echo $row_RecMain['d_data1']; ?></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>

              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">英文小標題</td>
                <td class="table_data"><?php echo $row_RecMain['d_data2']; ?></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>

            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
          	    	<td class="table_data"><?php echo $row_RecMain['d_title']; ?>
          	    	  <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecMain['d_id']; ?>" />
          	    	  <input name="delsure" type="hidden" id="delsure" value="1" /></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	    	</tr>

              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">副標題</td>
                <td class="table_data"><?php echo $row_RecMain['d_data3']; ?></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>

            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">簡介</td>
            	  <td class="table_data"><?php echo nl2br($row_RecMain['d_content']); ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>

              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">連結</td>
                <td class="table_data"><?php echo $row_RecMain['d_data4']; ?></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>

                <tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">日期</td>
          	    	<td class="table_data"><?php echo $row_RecMain['d_date']; ?></td>
        	    	<td width="250" bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
     	      	<tr>
...
<?php
    ...
    //----------刪除Mobile圖片資料到資料庫end(在主資料前)-----
	  ...
	  $deleteGoTo = "main_list.php?delchangeSort=1";
