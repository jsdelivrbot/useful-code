...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增媒體專區分類</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">分類名稱</td>
          	    	<td><input name="name" type="text" class="table_data" id="name" size="50">
          	    	  <input name="c_parent" type="hidden" id="c_parent" value="mediaT" /></td>
                ...
                <td class="table_data">
                  <div class="perm" id="perm_1">
                      ...
                      <label for="term_group_1">
                        <input name="term_group" type="radio" id="term_group_1" value="1" checked="checked" />
                            一般類型
                        </label>
                      <label for="term_group_2">
                        <input name="term_group" type="radio" id="term_group_2" value="2" />
                            影片類型
                        </label>
                      <label for="term_group_3">
                        <input name="term_group" type="radio" id="term_group_3" value="3" />
                            照片類型
                        </label>
                    </div>
                </td>
...
<?php
  ...
  $insertSQL = sprintf("INSERT INTO terms (name, name_en, slug, term_group, term_active) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($name, "text"),
                       GetSQLValueString($name_en, "text"),
                       GetSQLValueString($slug, "text"),
                       GetSQLValueString($term_group, "int"),
  ...
  $_SESSION['totalRows'] = $totalRows_RecMediaT;
	
   
  $insertGoTo = "mediaT_list.php?pageNum=0&totalRows_RecMediaT=".$_SESSION['totalRows']."&changeSort=1&now_term_id=".$new_data_num."&change_num=1";
  if (isset($_SERVER['QUERY_STRING'])) {
