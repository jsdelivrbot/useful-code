...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除最新消息</td>
            <td width="70%"><span class="no_data">確定刪除以下最新消息?</span></td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
  ...
  <?php
do {  
	if (!(strcmp($row_RecYears['c_id'], $row_RecNews['d_class2']))) {
...
?>
              ...
              <tr>
                ...
                <?php 
                  if (!(strcmp(1, $row_RecNews['d_class4']))) {
                    do { 
                      if (!(strcmp($row_RecArtistsT['term_id'], $row_RecNews['d_class3']))) {
            	...
            	<tr>
            	  ...
            	  <td class="table_data"><?php echo $row_RecNews['d_title']; ?></td>
            	...
            	<tr>
            	  ...
            	  <td class="table_data"><?php echo $row_RecNews['d_date']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
...
<?php
    ...
    while ( $row = mysql_fetch_assoc($result))
    {
	  ...
	  $deleteGoTo = "news_list.php?delchangeSort=1&selected1=".$_SESSION['selected_Years'];
