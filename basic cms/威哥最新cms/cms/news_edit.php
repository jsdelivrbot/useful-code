...
<?php require_once('photo_process_news.php'); ?>
<?php
...
if (isset($_SESSION['selected_Years'])){
	$G_selected1 = $_SESSION['selected_Years'] = $row_RecNews['d_class2'];
...
do {  
?>
            	      <option value="<?php echo $row_RecYears['c_id']?>" <?php if (!(strcmp($row_RecYears['c_id'], $row_RecNews['d_class2']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecYears['c_title']?></option>
            	      <?php
                ...
                <td class="table_data">
                  ...
                  <div class="relationshipRadio">
                    <label for="relationship_1">
                      <input name="relationship" type="radio" id="relationship_1" value="0" <?php if (!(strcmp(0, $row_RecNews['d_class4'])) || is_null($row_RecNews['d_class4'])) {echo ' checked="checked"';} ?> />
                          無
                      </label>
                    <label for="relationship_2">
                      <input name="relationship" type="radio" id="relationship_2" value="1" <?php if (!(strcmp(1, $row_RecNews['d_class4']))) {echo ' checked="checked"';} ?>/>
                          關聯
                      </label>
                  </div>
                  <div class="relationshipSelectGroup hide">
                    ...
                    <select name="d_class3" id="d_class3">
                      ...
                      do {  
                      ?>
                          <option value="<?php echo $row_RecArtistsT['term_id']?>"<?php if (!(strcmp($row_RecArtistsT['term_id'], $row_RecNews['d_class3']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecArtistsT['name'].' '.$row_RecArtistsT['name_en']?></option>
                          <?php
            	...
            	<tr>
            	  ...
            	  <td><label>
            	    <select name="d_active" class="table_data" id="d_active">
            	      <option value="0" <?php if (!(strcmp(0, $row_RecNews['d_active']))) {echo "selected=\"selected\"";} ?>>不公佈</option>
            	      <option value="1" <?php if (!(strcmp(1, $row_RecNews['d_active']))) {echo "selected=\"selected\"";} ?>>公佈</option>
            	      </select>
            	    </label></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
...
if( is_null($d_class4) ){
 ...
 //$y = substr($d_date, 0, 4);
  ...
  $updateGoTo = "news_list.php?selected1=".$d_class2."&changeSort=1&change_num=".$_POST['d_sort']."&now_d_id=".$d_id."&totalRows=".$_SESSION['totalRows']."&pageNum=".$_SESSION["ToPage"];
