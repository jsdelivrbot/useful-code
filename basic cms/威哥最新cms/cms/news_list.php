...
if ($G_changeSort==1||$G_delchangeSort==1) 
{
	...
	if($G_changeSort==1)
	{
		...
		/*}else
		{
			header("Location:news_list.php?selected1=".$row_RecYears['c_id']."&pageNum=".$_GET['pageNum']."&totalRows=".$_GET['totalRows']);
		}*/
	...
	}else if($G_delchangeSort==1)
	{
		...
		/*}else
		{
			header("Location:news_list.php?selected=".$row_RecYears['c_id']."&pageNum=".$_GET['pageNum']);
		}*/
	}
}
