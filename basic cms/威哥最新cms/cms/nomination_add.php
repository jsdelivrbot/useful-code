...
if (isset($_SESSION['selected_nominationT'])){
	$G_sel = $_SESSION['selected_nominationT'];
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增提名及評選</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
...
?>
                  ...
                  <td width="250" bgcolor="#e5ecf6">
                    <input name="d_class1" type="hidden" id="d_class1" value="nomination" />
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
 ...
 $d_data3	= checkV('d_data3');
  ...
  $insertSQL = sprintf("INSERT INTO data_set (d_title, d_title_en, d_content, d_class1, d_class2, d_tag, d_class3, d_class4, d_class5, d_class6, d_data1, d_data2, d_data3, d_price1, d_price2, d_date, d_active) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $Result1 = mysql_query($updateSQL, $connect2data) or die(mysql_error());
	...
	//----------插入圖片資料到資料庫end----------
	 //----------插入檔案資料到資料庫begin(須放入插入主資料後)----------
		...
		$file_result=file_process("nomination","add");
    ...
    $_SESSION['totalRows'] = $totalRows_RecNomination;
	
	
  $_SESSION['original_selected'] = $_SESSION['selected_nominationT'] = $tagTMP;

  $insertGoTo = "nomination_list.php?sel=".$tagTMP."&pageNum=0&totalRows_RecNomination=".$_SESSION['totalRows']."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
