...
if (isset($_SESSION['selected_nominationT'])){
	$G_sel = $_SESSION['selected_nominationT'] = $row_RecNomination['d_class2'];
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除提名及評選</td>
            <td width="70%"><span class="no_data">確定刪除以下提名及評選?</span></td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
...
do {
	...
	if (in_array($row_RecNominationT['term_id'], $selA)){
		echo '<li class="search-choice"><span>'.$row_RecNominationT['name'].'</span></li>';
	}
...
?>
            	...
            	<tr>
            	  ...
            	  <td class="table_data"><?php echo $row_RecNomination['d_title']; ?></td>
            	  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">英文標題</td>
            	  <td class="table_data"><?php echo $row_RecNomination['d_title_en']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">內容</td>
            	  <td class="table_data"><?php echo $row_RecNomination['d_content']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
                <tr>
                  <td align="center" bgcolor="#e5ecf6" class="table_col_title">時間</td>
                  <td class="table_data"><?php echo $row_RecNomination['d_date']; ?></td>
                  <td bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
     	      	<tr>
...
<?php
    ...
    //----------刪除圖片資料到資料庫end(在主資料前)-----
	  ...
	  $deleteGoTo = "nomination_list.php?delchangeSort=1&sel=".$G_sel;
