...
?>
              ...
              <table width="100%" border="0" cellspacing="3" cellpadding="5" id="addOtherReportArea">
                <tr>
                  <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">外部相關報導連結-標題1</td>
                ...
                <tr>
                  <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">外部相關報導-連結1</td>
                ...
                <tr>
                  ...
                  <td><input name="tabReport_data1[]" type="text" class="table_data" id="tabReport_data1_1" value="" size="20" /></td>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
 ...
 $d_data4	= is_null(checkV('d_data4')) ? NULL : implode (",", checkV('d_data4'));
  ...
  //----------插入動態相關外部影音連結到資料庫begin(須放入插入主資料後)----------
  //外部影音
