	...
	for($j=0;$j<count($FILES_A['name']);$j++)
	{
		...
		if($tmp_name!='')//如果有上傳檔案
		{
			...
			if($image_type=="jpg" || $image_type=="gif" || $image_type=="bmp" || $image_type=="png" || $image_type=="tif")
			{
						...
						$this_path1=$image_path."/".$file_name."_".$photo_name."@2x.".$image_type;
						...
						*/
						...
						//縮小圖-縮小1/2
						$this_path2=$image_path."/".$file_name."_".$photo_name."@1x.".$image_type;
						$this_image_path2 = "../".$this_path2;
						//copy($FILES_A['tmp_name'][$j] , $this_image_path );
						//$destW = 84;
						//$destH = 66;
						$srcSize   = getimagesize($this_image_path1); 
						$destW = ceil($srcSize[0]/2);
						$destH = ceil($srcSize[1]/2);

						imagesResize($this_image_path1,$this_image_path2,$destW,$destH);
						...
						$all_image_name[$j+1][3]=$this_path3;//1/2小圖
