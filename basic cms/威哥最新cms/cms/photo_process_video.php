		...
		if($tmp_name!='')//如果有上傳檔案
		{
			...
			if($image_type=="jpg" || $image_type=="gif" || $image_type=="bmp" || $image_type=="png" || $image_type=="tif")
			{
						...
						*/
						...
						$destW = 410;
						$destH = 273;
						$this_path4=$image_path."/".$file_name."_".$photo_name."_$destW.".$image_type;
						...
						$destW = 132;
						$destH = 88;
						$this_path5=$image_path."/".$file_name."_".$photo_name."_$destW.".$image_type;
						...
						$all_image_name[$j+1][2]=$this_path2;//縮小圖後台list用
						$all_image_name[$j+1][3]=$this_path3;//縮小圖284*188(列-小圖)

						$all_image_name[$j+1][6]=$this_path4;//410*273(大圖-藝)
						$all_image_name[$j+1][7]=$this_path5;//132*88(大圖-藝)
