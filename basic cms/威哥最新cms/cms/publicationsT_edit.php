...
$colname_RecPublicationsT = "-1";
if (isset($_GET['term_id'])) {
  $colname_RecPublicationsT = $_GET['term_id'];
}
mysql_select_db($database_connect2data, $connect2data);
$query_RecPublicationsT = sprintf("SELECT * FROM terms WHERE term_id = %s", GetSQLValueString($colname_RecPublicationsT, "int"));
...
if($totalRows_RecPublicationsT==0){
  header("Location: publicationsT_list.php");
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">修改出版品分類</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="3" cellpadding="5">
            <tr>
              ...
              <td width="516"><input name="name" type="text" class="table_data" id="name" value="<?php echo $row_RecPublicationsT['name']; ?>" size="50" />
                  <input name="term_id" type="hidden" id="term_id" value="<?php echo $row_RecPublicationsT['term_id']; ?>" /></td>
            ...
            <tr>
              ...
              <td width="516"><label>
                <select name="term_active" class="table_data" id="term_active">
                  <option value="0" <?php if (!(strcmp(0, $row_RecPublicationsT['term_active']))) {echo "selected=\"selected\"";} ?>>不公佈</option>
                  <option value="1" <?php if (!(strcmp(1, $row_RecPublicationsT['term_active']))) {echo "selected=\"selected\"";} ?>>公佈</option>
                </select>
              </label></td>
              <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
            </tr>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "publicationsT_list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
