...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
 ...
 //$d_price1 =(isset($_POST['d_price1']) && $_POST['d_price1']=='') ? 0 : $_POST['d_price1'] ;
 //$d_price2 =(isset($_POST['d_price2']) && $_POST['d_price2']=='') ? 0 : $_POST['d_price2'] ;
   $d_price1 =  $d_price2 = NULL;
 ...
 $d_data3	= checkV('d_data3');
  ...
  $Result1 = mysql_query($updateSQL, $connect2data) or die(mysql_error());
	...
	//----------插入圖片資料到資料庫end----------
      ...
      $file_result=file_process("public","add");
  ...
  $G_sel = $tagTMP;
  //$updateGoTo = "publications_list.php?sel=".$class2."&selected2=".$class3."&changeSort=1&change_num=".$_POST['term_order']."&now_d_id=".$d_id."&totalRows_RecPublications=".$_SESSION['totalRows']."&pageNum=".$_SESSION["ToPage"];
