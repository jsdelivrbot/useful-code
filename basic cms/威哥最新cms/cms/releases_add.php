...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增最新發行</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
...
?>
                ...
                <tr>
                  ...
                  <td><label>
                    <select name="d_class5" id="d_class5" class="table_data">
                      ...
                      do {  
                      ?>
                      <option value="<?php echo $row_RecReleasesC['c_id']?>"><?php echo $row_RecReleasesC['c_title']?></option>
                      <?php
              ...
              <tr>
                  ...
                  <td><input name="d_data2" type="text" class="table_data" id="d_data2" value="" size="80" />
...
echo $date->format("Y");*/
  ...
  $insertSQL = sprintf("INSERT INTO data_set (d_title, d_content, d_data1, d_data2, d_class1, d_class2, d_class3, d_class4, d_class5, d_date, d_active) VALUES (%s, %s, %s, %s, 'releases', %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "releases_list.php?selected1=".$d_class2."&pageNum=0&totalRows=".($_SESSION['totalRows']+1)."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
