...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增董監事</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <div class="groupBtn">
      ...
      if(isset($_SESSION['listLinks']) && $_SESSION['listLinks']!=''){ 
          ...
          if( (isset($_GET['now_d_id'])&&$_GET['now_d_id']!='') ){
            $reviewLink = "http://".$_SERVER['HTTP_HOST'].$nowFile."/"."supervisor.php?cat=".$_GET['now_d_id'];
          }else{
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">姓名</td>
          	    	<td><input name="d_title" type="text" class="table_data" id="d_title" value="" size="70" />
          	    	  <input name="d_class1" type="hidden" id="d_class1" value="supervisor" /></td>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
 ...
 $d_pub  = checkV('d_pub');
  ...
  $insertSQL = sprintf("INSERT INTO data_set (d_title, d_title_en, d_content, d_class1, d_class2, d_date, d_active, d_pub) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $totalRows = mysql_num_rows($RecSupervisor);

  $_SESSION['totalRows'] = $totalRows;


  $stringLink = "?pageNum_RecSupervisor=0&totalRows_RecSupervisor=".$_SESSION['totalRows']."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
  
  $insertGoTo = "supervisor_list.php".$stringLink;
	
  //$insertGoTo = "supervisor_list.php?pageNum_RecSupervisor=0&totalRows_RecSupervisor=".$_SESSION['totalRows']."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  $selfLink = "supervisor_add.php".$stringLink;
