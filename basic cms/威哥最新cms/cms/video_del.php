...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除影音</td>
            <td width="70%"><span class="no_data">確定刪除以下影音?</span></td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
  ...
  <?php
do {  
	if (!(strcmp($row_RecYears['c_id'], $row_RecVideo['d_class2']))) {
...
?>
              ...
              <tr>
                ...
                <?php 
                  if (!(strcmp(1, $row_RecVideo['d_class4']))) {
                    do { 
                      if (!(strcmp($row_RecArtistsT['term_id'], $row_RecVideo['d_class3']))) {
            	...
            	<tr>
            	  ...
            	  <td class="table_data"><?php echo $row_RecVideo['d_title']; ?></td>
            	  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">內容</td>
            	  <td class="table_data"><?php echo $row_RecVideo['d_content']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>

              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">youtube影片碼</td>
                <td class="table_data"><?php echo $row_RecVideo['d_data1']; ?></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <?php } // Show if recordset not empty ?>
            	...
            	<tr>
            	  ...
            	  <td class="table_data"><?php echo $row_RecVideo['d_date']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
...
<?php
    ...
    while ( $row = mysql_fetch_assoc($result))
    {
	  ...
	  $deleteGoTo = "video_list.php?delchangeSort=1&selected1=".$_SESSION['selected_Years'];
