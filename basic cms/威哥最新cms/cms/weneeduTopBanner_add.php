...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO data_set (d_title, d_title_en, d_content, d_data1, d_data2, d_data3, d_data4, d_class1, d_class2, d_class6, d_date, d_active, d_pub) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString("weneeduTopBanner", "text"),
  ...
  $Result1 = mysql_query($insertSQL, $connect2data) or die(mysql_error());
    ...
    //$image_result=image_process("weneeduTopBanner","add", "0", "0");
    //一般附圖  
...
if($ifFile){
  ...
  $insertGoTo = "weneeduTopBanner_list.php".$stringLink;
  ...
  $selfLink = "weneeduTopBanner_add.php".$stringLink;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增誠徵作家上方banner</td>
            <td width="70%">&nbsp;
            </td>
        </tr>
	</table>
