...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">新增誠徵作家</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
            	...
            	<tr>
                	<td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
          	    	<td><input name="d_title" type="text" class="table_data" id="d_title" value="" size="70" />
          	    	  <input name="d_class1" type="hidden" id="d_class1" value="weneedu" /></td>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  //----------插入動態相關外部報導連結到資料庫end----------
    ...
    //----------插入圖片資料到資料庫begin(須放入插入主資料後)----------
		...
		//$image_result=image_process("weneedu","add", "0", "0");
  ...
  $totalRows = mysql_num_rows($RecWeneedu);

  $_SESSION['totalRows'] = $totalRows;
	
  $insertGoTo = "weneedu_list.php?pageNum_RecWeneedu=0&totalRows_RecWeneedu=".$_SESSION['totalRows']."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
  if (isset($_SERVER['QUERY_STRING'])) {
