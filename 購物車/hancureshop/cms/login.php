...
if (isset($_POST['user_name'])) {
  ...
  $LoginRS__query=sprintf("SELECT user_name, user_password, user_level FROM `admin` WHERE user_name=%s AND user_password=%s AND user_active='1' ",
...
<form action="<?php echo $loginFormAction; ?>" method="POST" name="form1" id="form1">
    ...
    <h2 class="art-logo-text">HanCure 漢速敷</h2>
