	...
	for($j=0;$j<count($FILES_A['name']);$j++)
	{
		...
		if($tmp_name!='')//如果有上傳檔案
		{
			...
			if($image_type=="jpg" || $image_type=="gif" || $image_type=="bmp" || $image_type=="png" || $image_type=="tif")
			{
						...
						imagesResize_7($this_image_path1,$this_image_path1,$image_width,$image_height);
						...
						*/
						...
						//縮小圖後台list用
						$this_path2=$image_path."/".$file_name."_".$photo_name."_s90.".$image_type;
						$this_image_path2 = "../".$this_path2;
						copy($FILES_A['tmp_name'][$j] , $this_image_path2 );						
						$destW = 90;
						$destH = 90;
						...
						//echo 'finish 2<br>';
						//縮小圖list用-正方形
						$this_path3=$image_path."/".$file_name."_".$photo_name."_s117.".$image_type;
						$this_image_path3 = "../".$this_path3;
						copy($FILES_A['tmp_name'][$j] , $this_image_path3 );
						$destW = 117;
						$destH = 117;
						//imagesResize_2($this_image_path3,$this_image_path3,$destW,$destH);
						imagesResize_7($this_image_path3,$this_image_path3,$destW,$destH);
