...
<img src="http://www.hancure.com/step/step1.png" />
<p><strong>Step2.點選訂單紀錄，並選擇要回報之訂單</strong></p>
<img src="http://www.hancure.com/step/step2.png" />
<img src="http://www.hancure.com/step/step3.png" />
<p><strong>Step1.填寫匯款資訊</strong></p>
<img src="http://www.hancure.com/step/step4.png" /><br><br>';
	}else{
...
$phpmailer->SetFrom('info@hancure.com', "HanCure 漢速敷-訂購單通知");
$phpmailer->AddReplyTo("info@hancure.com","HanCure 漢速敷-訂購單通知");
...
$phpmailer->AddAddress('info@hancure.com', "HanCure 漢速敷");//
//$phpmailer->AddAddress('williamshsu@gmail.com', "HanCure 漢速敷");//
//$phpmailer->AddCC('williams188@msn.com');
$phpmailer->AddBCC("williambossmailg@gmail.com", 'HanCure 漢速敷-訂購單通知');
$phpmailer->IsHTML(true);
