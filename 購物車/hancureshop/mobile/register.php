...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1") && $_POST["insertC"] == 1) {
  ...
  $insertSQL = sprintf("INSERT INTO member_set (m_name, m_account, m_password, m_gender, m_birthyear, m_birthmonth, m_birthday, m_email, m_phone, m_cellphone, m_zip, m_city, m_canton, m_address, m_active, m_date) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
