...
?></li>
		...
		<div class="area5"> <!-- 運送方式 -->
			...
			<ul>
				...
				<li class="right">購物滿 <?php echo ($row_Freight['d_price1']!='')?$row_Freight['d_price1']:'499';?> 元(含)以上免運費，未滿 <?php echo ($row_Freight['d_price1']!='')?$row_Freight['d_price1']:'499';?> 元，<br>運費為 <?php echo ($row_Freight['d_price2']!='')?$row_Freight['d_price2']:'100';?> 元。</li>
			</ul>
		</div><!-- area5 end -->
  ...
  <div data-role="district" data-style="" data-value=""></div>
		...
		<div class="area7"> <!-- 付款方式 -->
			...
			<ul>
				...
				<li class="right">
					<p id="payTxt1">當您的訂單資料成立後，您需於 3 天內完成匯款，以利如期出貨。<br /><br/>
					...
					<p id="payTxt2">貨到付款金額超過 2 萬元者，請選擇ATM轉帳付款，謝謝您。</p>
				</li>
			</ul>
		</div><!-- area7 end -->
