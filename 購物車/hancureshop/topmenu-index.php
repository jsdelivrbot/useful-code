...
<div class="topmenu">
	...
	<ul class="topmenu-nav">
        ...
        <li class="main-nav"><a href="javascript:;" class="aboutLink">
        	<div class="chtitle"><img src="img/micon2.png" class="wicon">關於我們</div>
...
<div class="leftmenu-block">
	...
	<ul class="leftmenu">
		<li class="" id="topmenu-goabout">
			<a href="javascript:;">
				<div class="chtitle jp-serif"><img src="img/micon2.png" class="wicon">關於我們</div>
				<div class="entitle jp-serif">About</div>
			</a>
		</li>
		<li class="">
		...
		<!-- <li id="topmenu-goabout"><a href="javascript:;"><img src="images/topmenu1.png" width="40" height="101"></a></li>
		<li><a href="news.php"><img src="images/topmenu2.png" width="40" height="102"></a></li>
		<li><a href="products.php"><img src="images/topmenu3.png" width="40" height="101"></a></li>
		<li id="topmenu-gocontact"><a href="javascript:;"><img src="images/topmenu4.png" width="40" height="101"></a></li>
		<li><a href="howtobuy.php"><img src="images/topmenu5.png" width="40" height="102"></a></li> -->
	</ul>
</div> 
