...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">修改聯絡我們</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  		...
  		<tr>
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="5">
            	...
            	<tr>
            	  ...
            	  <td><input name="d_content" type="text" class="table_data " id="d_content" value="<?php echo $row_RecContact['d_content']; ?>" size="70" /></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">服務專線</td>
            	  <td><input name="d_class3" type="text" class="table_data " id="d_class3" value="<?php echo $row_RecContact['d_class3']; ?>" size="70" /></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">Email</td>
                <td><input name="d_class4" type="text" class="table_data " id="d_class4" value="<?php echo $row_RecContact['d_class4']; ?>" size="70" /></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
            	<tr>
            	  ...
            	  <td bgcolor="#e5ecf6"><span class="note_letter">*請直接輸入地圖座標。<br />
            	    例如:22.663720, 120.319145</span></td>
          	  </tr>
                <tr>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE data_set SET d_title=%s, d_content=%s, d_class2=%s, d_class3=%s, d_class4=%s, d_date=%s, d_active=%s WHERE d_id=%s",
