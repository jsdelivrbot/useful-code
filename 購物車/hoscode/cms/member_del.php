  		...
  		<tr>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="3">
              ...
              <tr>
                ...
                <td class="table_data"><?php echo $row_RecMember['m_birthyear'].'/'.$row_RecMember['m_birthmonth'].'/'.$row_RecMember['m_birthday']; ?></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">國家</td>
                <td class="table_data"><?php echo $row_RecMember['m_country']; ?></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">郵遞區號</td>
                <td class="table_data"><?php echo $row_RecMember['m_zip']; ?></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">地址</td>
                <td class="table_data"><?php echo $row_RecMember['m_address']; ?></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              <tr>
