...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $m_class2         = checkV("m_class2");
  $m_class3         = checkV("m_class3");
  ...
  $m_city      = checkV("m_city");
  $m_canton      = checkV("m_canton");
  $county      = checkV("county");
  $district      = checkV("district");
  $m_address      = checkV("m_address");
  $m_epaper      = checkV("m_epaper");
  $m_level      = checkV("m_level");
  ...
  $updateSQL = sprintf("UPDATE member_set SET m_name=%s, m_class2=%s, m_class3=%s,  m_gender=%s, m_birthyear=%s, m_birthmonth=%s, m_birthday=%s, m_email=%s, m_phone=%s, m_cellphone=%s, m_zip=%s, m_city=%s, m_canton=%s, m_address=%s, m_country=%s, m_country_code=%s, m_epaper=%s, m_level=%s, m_active=%s, m_date=%s WHERE m_id=%s",
                       GetSQLValueString($m_name, "text"),
                       GetSQLValueString($m_class2, "text"),
                       GetSQLValueString($m_class3, "text"),
                       ...
                       GetSQLValueString($m_cellphone, "text"),
          					   ...
          					   GetSQLValueString($m_city, "text"),
          					   GetSQLValueString($m_canton, "text"),
                       GetSQLValueString($m_address, "text"),
                       GetSQLValueString($country, "text"),
                       GetSQLValueString($country_code, "text"),
                       GetSQLValueString($m_epaper, "int"),
                       GetSQLValueString($m_level, "text"),
                       GetSQLValueString($m_active, "text"),
...
<option value="1" <?php if (!(strcmp(1, $row_RecMember['m_gender']))) {echo "selected=\"selected\"";} ?>>先生</option><option value="0" <?php if (!(strcmp(0, $row_RecMember['m_gender']))) {echo "selected=\"selected\"";} ?>>女士</option>
              ...
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">生日</td>
                <td class="table_data"><input name="m_birthday" type="text" class="textcss" id="m_birthday" placeholder="西元/月/日" value="<?php echo $row_RecMember['m_birthyear'].'/'.$row_RecMember['m_birthmonth'].'/'.$row_RecMember['m_birthday']; ?>" data-mask="yyyy/mm/dd"></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
              ...
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">國家</td>
                <td>
                  <div class="form-item table_data">
                    <input type="text" id="country" name="country" class="table_data">
              ...
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">郵遞區號</td>
                <td><input type="text" name="zipcode" id="zipcode" placeholder="" class="textcss table_data" style="width:75px" value="<?php echo $row_RecMember['m_zip']; ?>"></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
