...
echo $date->format("Y");*/
  ...
  $insertSQL = sprintf("INSERT INTO data_set (d_title, d_content, d_class1, d_class2, d_class3, d_class4, d_date, d_active) VALUES (%s, %s, 'news', %s, %s, %s, %s, %s)",
