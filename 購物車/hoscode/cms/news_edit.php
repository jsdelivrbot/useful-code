...
$RecNewsY = mysql_query($query_RecNewsY, $connect2data) or die(mysql_error());
$row_RecNewsY = mysql_fetch_assoc($RecNewsY);
$totalRows_RecNewsY = mysql_num_rows($RecNewsY);
...
?>
            	...
            	<tr>
            	  ...
            	  <td bgcolor="#e5ecf6"><p class="red_letter">*小斷行請按Shift+Enter。<br />
            	    輸入區域的右下角可以調整輸入空間的大小。<br />
            	    *圖片請上傳寬不大於 805pixel、解析度 72dpi 之圖檔。            	  </p></td>
          	  </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">手機版內容</td>
            	  <td class="table_data"><textarea name="d_class4" cols="100" rows="20" class="table_data tiny" id="d_class4"><?php echo $row_RecNews['d_class4']; ?></textarea></td>
            	  <td bgcolor="#e5ecf6"><p class="red_letter">*小斷行請按Shift+Enter。<br />
            	    輸入區域的右下角可以調整輸入空間的大小。<br />
            	    *圖片請上傳寬不大於 828pixel、解析度 72dpi 之圖檔。            	  </p></td>
          	  </tr>
                <tr>
