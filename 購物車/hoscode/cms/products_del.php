...
if (isset($_SESSION['selected_productsT'])){
	$G_selected1 = $_SESSION['selected_productsT'] = $row_RecProducts['d_class2'];
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">刪除產品介紹</td>
            <td width="70%"><span class="no_data">確定刪除以下產品介紹?</span></td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
...
do {
	...
	if (in_array($row_RecProductsT['term_id'], $selA)){
		echo '<li class="search-choice"><span>'.$row_RecProductsT['name'].'</span></li>';
	}
...
?>
            	...
            	<tr>
            	  ...
            	  <td class="table_data"><?php echo $row_RecProducts['d_title']; ?></td>
            	  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
              <tr>
                <td align="center" bgcolor="#e5ecf6" class="table_col_title">產品名稱-內容用</td>
                <td class="table_data"><?php echo nl2br($row_RecProducts['d_class5']); ?></td>
                <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
              </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">售價</td>
            	  <td class="table_data"><?php echo $row_RecProducts['d_price1']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">數量</td>
            	  <td class="table_data"><?php echo $row_RecProducts['d_price2']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">規格說明</td>
            	  <td class="table_data"><?php echo $row_RecProducts['d_class3']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">產品說明</td>
            	  <td class="table_data"><?php echo $row_RecProducts['d_content']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">產品備註</td>
            	  <td class="table_data"><?php echo $row_RecProducts['d_class4']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">手機版規格說明</td>
            	  <td class="table_data"><?php echo $row_RecProducts['d_data1']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">手機版產品說明</td>
            	  <td class="table_data"><?php echo $row_RecProducts['d_data2']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">手機版產品備註</td>
            	  <td class="table_data"><?php echo $row_RecProducts['d_data3']; ?></td>
            	  <td bgcolor="#e5ecf6">&nbsp;</td>
          	  </tr>
                <tr>
                  <td align="center" bgcolor="#e5ecf6" class="table_col_title">時間</td>
                  <td class="table_data"><?php echo $row_RecProducts['d_date']; ?></td>
                  <td bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
     	      	<tr>
...
<?php
	if ((isset($_REQUEST['d_id'])) && ($_REQUEST['d_id'] != "") && (isset($_REQUEST['delsure']))) {
	  ...
	  $deleteGoTo = "products_list.php?delchangeSort=1&selected1=".$G_selected1."&selected2=".$G_selected2;
