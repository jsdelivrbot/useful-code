...
if (isset($_GET['d_id'])) {
  $colname_RecProducts = $_GET['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
$query_RecProducts = sprintf("SELECT * FROM term_relationships AS TR, data_set AS D, terms AS T WHERE TR.term_taxonomy_id = T.term_id AND D.d_id = TR.object_id AND D.d_id = %s", GetSQLValueString($colname_RecProducts, "int"));
...
if (isset($_SESSION['selected_productsT'])){
	$G_selected1 = $_SESSION['selected_productsT'] = $row_RecProducts['term_id'];
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="30%" class="list_title">修改產品介紹</td>
            <td width="70%">&nbsp;</td>
        </tr>
	</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
            	  ...
            	  <td>
            	    <label>
            	      <select data-placeholder="請選擇分類..." class="chosen-select table_data" tabindex="4" name="d_class2[]" id="d_class2">
            	        <?php
do {
	$selA = explode(',',$row_RecProducts['d_tag']);
	if (in_array($row_RecProductsT['term_id'], $selA)){
		$sel = "selected=\"selected\"";
	}else{
		$sel = "";
	}
?>
            	        <option value="<?php echo $row_RecProductsT['term_id']?>"<?php echo $sel; ?>><?php echo $row_RecProductsT['name']?><?php //echo $row_RecProductsT['term_id']?></option>
            	        <?php
...
?>
            	...
            	<tr>
            	  ...
            	  <td><input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_RecProducts['d_title']; ?>" size="50" />
          	    </td>
            	  <td bgcolor="#e5ecf6">                  
            	    <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecProducts['d_id']; ?>" />
                    <input name="term_order" type="hidden" id="term_order" value="<?php echo $row_RecProducts['term_order']; ?>" /><?php //echo $row_RecUnitary['term_order']; ?>
                  </td>
          	  </tr>
              ...
              <tr>
                ...
                <td><textarea name="d_class5" cols="100" rows="20" class="table_data" id="d_class5"><?php echo $row_RecProducts['d_class5']; ?></textarea></td>
                <td bgcolor="#e5ecf6">&nbsp;</td>
              </tr>

            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">售價</td>
            	  <td><input name="d_price1" type="text" class="table_data" id="d_price1" value="<?php echo $row_RecProducts['d_price1']; ?>" size="50" /></td>
            	  <td bgcolor="#e5ecf6"><span class="red_letter">*請輸入阿拉伯數字。</span></td>
            	  </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">數量</td>
            	  <td><input name="d_price2" type="text" class="table_data" id="d_price2" value="<?php echo $row_RecProducts['d_price2']; ?>" size="50" /></td>
            	  <td bgcolor="#e5ecf6"><span class="red_letter">*請輸入阿拉伯數字。</span></td>
            	  </tr>
            	<tr>
            	  <td align="center" bgcolor="#e5ecf6" class="table_col_title">規格說明</td>
            	  <td><textarea name="d_class3" cols="100" rows="20" class="table_data tiny" id="d_class3"><?php echo $row_RecProducts['d_class3']; ?></textarea></td>
            	...
            	<tr>
            	  ...
            	  <td><textarea name="d_content" cols="100" rows="20" class="table_data tiny" id="d_content"><?php echo $row_RecProducts['d_content']; ?></textarea></td>
            	...
            	<tr>
            	  ...
            	  <td><textarea name="d_class4" cols="100" rows="20" class="table_data tiny" id="d_class4"><?php echo $row_RecProducts['d_class4']; ?></textarea></td>
            	  <td bgcolor="#e5ecf6"><span class="red_letter">*斷行請按Shift+Enter。<br />
            	    輸入區域的右下角可以調整輸入空間的大小。</span></td>
            	  </tr>
              ...
              <tr>
            	  ...
            	  <td><textarea name="d_data1" cols="100" rows="20" class="table_data tiny" id="d_data1"><?php echo $row_RecProducts['d_data1']; ?></textarea></td>
            	  <td bgcolor="#e5ecf6"><span class="red_letter">*斷行請按Shift+Enter。<br />
輸入區域的右下角可以調整輸入空間的大小。</span>
              ...
              <tr>
            	  ...
            	  <td><textarea name="d_data2" cols="100" rows="20" class="table_data tiny" id="d_data2"><?php echo $row_RecProducts['d_data2']; ?></textarea></td>
            	  <td bgcolor="#e5ecf6"><p class="red_letter">*小斷行請按Shift+Enter。<br />
            	    輸入區域的右下角可以調整輸入空間的大小。</p>
            	...
            	<tr>
            	  ...
            	  <td><textarea name="d_data3" cols="100" rows="20" class="table_data tiny" id="d_data3"><?php echo $row_RecProducts['d_data3']; ?></textarea></td>
            	  <td bgcolor="#e5ecf6"><span class="red_letter">*斷行請按Shift+Enter。<br />
輸入區域的右下角可以調整輸入空間的大小。</span></td>
          	  </tr>
        ...
        <label for="d_new_product_0">
        	<input <?php if (!(strcmp($row_RecProducts['d_new_product'],"0"))) {echo "checked=\"checked\"";} ?> name="d_new_product" type="radio" id="d_new_product_0" value="0" checked="checked"  />
       	無
        </label>
        <label for="d_new_product_1">
        	<input <?php if (!(strcmp($row_RecProducts['d_new_product'],"1"))) {echo "checked=\"checked\"";} ?> name="d_new_product" id="d_new_product_1" type="radio" value="1"  />
       	主力商品
        </label>
        <label for="d_new_product_2">
        	<input <?php if (!(strcmp($row_RecProducts['d_new_product'],"2"))) {echo "checked=\"checked\"";} ?> name="d_new_product" type="radio" id="d_new_product_2" value="2"  />
        熱賣商品
       	</label>
        <label for="d_new_product_3">
        	<input <?php if (!(strcmp($row_RecProducts['d_new_product'],"3"))) {echo "checked=\"checked\"";} ?> name="d_new_product" type="radio" id="d_new_product_3" value="3"  />
        新商品
       	</label>
        </td>
                  <td bgcolor="#e5ecf6">&nbsp;</td>
            	...
            	<!--<tr>
                  ...
                  <td><textarea name="d_content" cols="50" rows="5" class="table_data" id="d_content"><?php //echo $row_RecProducts['d_content']; ?></textarea></td>
                ...
                <tr>
                  ...
                  <td><input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo $row_RecProducts['d_date']; ?>" size="50" /></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
                <tr>
                  ...
                  <td><label>
                    <select name="d_active" class="table_data" id="d_active">
                      <option value="0" <?php if (!(strcmp(0, $row_RecProducts['d_active']))) {echo "selected=\"selected\"";} ?>>不公佈</option>
                      <option value="1" <?php if (!(strcmp(1, $row_RecProducts['d_active']))) {echo "selected=\"selected\"";} ?>>公佈</option>
                    </select>
                  </label></td>
                  <td bgcolor="#e5ecf6">&nbsp;</td>
      	      	</tr>
                <?php if ($totalRows_RecImage > 0) { // Show if recordset not empty ?>
                  <tr>
                    ...
                    <td bgcolor="#e5ecf6" class="table_col_title"><p class="red_letter">*<?php echo $imagesSize[$_SESSION['nowMenu']]['note'];?></p>
                      <p class="red_letter"> 最多上傳四張圖片。</p></td>
                  </tr>
                  <?php } // Show if recordset not empty ?>
                  <?php if ($totalRows_RecImage < 4) {  ?>
                  ...
                  <tr>
                    ...
                    <p class="red_letter">*<?php echo $imagesSize[$_SESSION['nowMenu']]['note'];?></p><p class="red_letter">
                      最多上傳四張圖片。</p></td>
                </tr>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
 ...
 $d_data3	= checkV('d_data3');
  ...
  $_SESSION['original_selected']=$_SESSION['selected_products'];
  $G_selected1 = $d_tag;
  //$updateGoTo = "products_list.php?selected1=".$class2."&selected2=".$class3."&changeSort=1&change_num=".$_POST['term_order']."&now_d_id=".$_POST['d_id']."&totalRows_RecProducts=".$_SESSION['totalRows']."&pageNum=".$_SESSION["ToPage"];
  $updateGoTo = "products_list.php?selected1=".$G_selected1."&changeSort=1&change_num=".$_POST['term_order']."&now_d_id=".$d_id."&totalRows_RecProducts=".$_SESSION['totalRows']."&pageNum=".$_SESSION["ToPage"];
