...
function initialize()
{
  var myLatLng = new google.maps.LatLng(<?php echo isset($row_ReCcontact['d_class2'])?$row_ReCcontact['d_class2']:'24.254458, 120.721743'; ?>);
  var mapProp = {
  center:new google.maps.LatLng(<?php echo isset($row_ReCcontact['d_class2'])?$row_ReCcontact['d_class2']:'24.254458, 120.721743'; ?>),
  zoom:18,
  scrollwheel: false,
...
<?php $now="index"; ?>
	<div class="banner">
		...
		<div class="menu-block">
			...
			<ul>
				<li class="" id="gotoabout">
					<a href="javascript:;">
						<div class="chtitle jp-serif"><img src="img/micon.png" class="wicon">關於 C+H</div>
						<div class="entitle jp-serif">Be Yorself</div>
					</a>
				</li>
				<li class="">
					<a href="news.php">
				...
				<!-- <li class="">
					<a href="http://www.chstudio2010.com/" target="_blank">
		...
		<div class="toplogo"><a href="index.php"><img src="img/logo.png" width="157"></a></div>
...
?>     
		...
		<div class="area2" id="about">
			<div class="bigtitle">
				<div class="ch">關於 C+H</div>
				<div class="en">Be Yorself</div>
			</div>
...
<?php } // Show if recordset not empty ?>
		...
		<div class="area3" id="contact">
			...
			<div class="contact">
				<div class="contact-img-container"><img src="img/index-contact-title.png" width="156"></div>
				<div class="contact-info-container">
					<p>Studio / <?php echo $row_ReCcontact['d_content']; ?></p>
					<!-- <p>服務專線 / <?php //echo $row_ReCcontact['d_class3']; ?></p> -->
					<p>E-mail / <a href="mailto:<?php echo $row_ReCcontact['d_class4']; ?>"><?php echo $row_ReCcontact['d_class4']; ?></a></p>
				</div>
