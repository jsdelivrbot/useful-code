        ...
        <form action="<?php echo $editFormAction; ?>"  method="post" enctype="multipart/form-data" name="modifyForm"  id="modifyForm">
			...
			<ul class="left">
			  ...
			  <?php } ?>
				...
				<li class="item9"><span>郵遞區號</span> <input type="text" name="zipcode" id="zipcode" placeholder="" class="textcss" style="width:75px" value="<?php echo $row_RecMember['m_zip']; ?>"></li>
