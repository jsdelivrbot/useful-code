...
try
{
	...
	/* 基本參數 */
	//收到付款完成通知的伺服器端網址
	$oPayment->Send['ReturnURL'] = _RETURNURL_MOBILE;
	//歐付寶返回按鈕導向的瀏覽器端網址
	$oPayment->Send['ClientBackURL'] = _CLIENTBACKURL_MOBILE;
	//收到付款完成通知的瀏覽器端網址
	$oPayment->Send['OrderResultURL'] = _ORDERRESULTURL_MOBILE;
	//此筆訂單交易編號
	...
	//裝置Device 預設桌機版 PC 手機版 Mobile
	$oPayment->Send['DeviceSource'] = DeviceType::Mobile;
	//您不要顯示的付款方式
	$oPayment->Send['IgnorePayment'] = ""; // 例(排除支付寶與財富通): Alipay#Tenpay

	// 加入選購商品資料。
	$webURL = _WEBURL . "mobile/goods_detail.php?id="; 
