...
<div class="topmenu-fixed">
	...
	<div class="logo"><a href="index.php"><img src="images/topmanu-logo-w.png" width="82"></a></div>

	<div class="car"><a href="order_list.php"><span class="car-num"><?php echo $cart->itemCount;?></span><img src="images/topmenu-car-w.png" width="28"></a></div>
</div><!-- topmenu end -->
