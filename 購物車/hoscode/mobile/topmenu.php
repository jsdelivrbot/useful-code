...
<div class="topmenu">
	...
	<div class="logo"><a href="index.php"><img src="images/topmanu-logo.png" width="104"></a></div>
...
<script type="text/javascript">
	...
	$(".hamburger").click(function  () {
		$("ul.topmenu-on").toggleClass("topmenu-on-toggle");
		$(this).toggleClass("hamburgerAnimated");
	})

	$("ul.topmenu-on").click(function  () {
		$(this).removeClass("topmenu-on-toggle");
	})
