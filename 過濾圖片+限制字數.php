<!-- 新招 -->
<?php mb_strimwidth(strip_tags($row_RecProjects['d_content']), $start, $width, $trimmarker, $charset); ?>

<!-- 不斷字 -->
<?= substr(strip_tags($row_RecProjects['d_content']), 0, strrpos(substr($row_RecProjects['d_content'], 0, 150), ' ')); ?>
